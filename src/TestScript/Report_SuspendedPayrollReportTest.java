...
public class Report_SuspendedPayrollReportTest extends BaseClass {
...
//	String project2 = "712 West Peachtree";
	...
	public void testSuspendedPayrollReport(String ProgramName, String Division, String Projects,String userName, String password,String ProjectNAME1,String ProjectNAME2)
...
//			WPO_LoginActionClientWise.logInLockton(driver);
			...
			try {
				wb.selectSingleValue(Report_SuspendedPayrollReport.filterSelectDivisionDropdown(driver), Division);
				test.log(LogStatus.PASS, Division + " Selected Successfully");	
			} catch (Throwable e) {
				System.out.println(e);
			}
			
			Report_SuspendedPayrollReport.filterSelectProjectFormOption(driver, Projects).click();
			test.log(LogStatus.PASS, Projects + " Project Selected Successfully");
			wb.selectSingleValue(Report_SuspendedPayrollReport.filterSelectContractorFormOption(driver),
					"All Contractors");
