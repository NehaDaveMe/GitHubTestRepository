...
public class Report_ProjectFinancialAnalysisWorkClass_Old_Test extends BaseClass {
	...
	String selectReportName2 = "Project Financial Analysis Work Class ";
	...
	public void testProjectFinancialAnalysisWorkClasstOld(String ProgramName, String Division, String Projects,
		...
		try {
			...
			System.out.println(driver.findElement(By.xpath("//span[contains(text(),'Financial Analysis WorkClass Report')]")).getText());
			//there is issue in name project and remaining words taking in diff tag
			Assert.assertEquals(driver.findElement(By.xpath("//span[contains(text(),'Financial Analysis WorkClass Report')]")).getText(),
		...
		Thread.sleep(10000);
		if (wb.isFileDownloaded("Project_Financial_Analysis_Work_Class.xls") == true) {
