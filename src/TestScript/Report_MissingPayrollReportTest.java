...
public class Report_MissingPayrollReportTest extends BaseClass {
	WebDriverCommonLib wb = new WebDriverCommonLib();
	String selectReportName = "Missing Payroll Report";
	String fromDate="Jan - 2020";
	String toDate="Apr - 2021";
//	String project1 = "120 Piedmont Student Housing";
//	String project2 = "712 West Peachtree";
	
	@Test(dataProvider = "excelData")
	public void testMissingPayrollReport(String ProgramName, String Division, String Projects,String userName, String password ,String ProjectNAME1,String ProjectNAME2 )
...
//			WPO_LoginActionClientWise.logInLockton(driver);
			...
			try {
				wb.selectSingleValue(Report_MissingPayrollReport.filterSelectDivisionDropdown(driver), Division);
			...
			wb.selectSingleValue(Report_MissingPayrollReport.selectFromMonth(driver), fromDate);
			test.log(LogStatus.PASS, fromDate+" From Date Added Successfully");
			
			wb.selectSingleValue(Report_MissingPayrollReport.selectToMonth(driver), toDate);
			test.log(LogStatus.PASS, toDate+" To Date Added Successfully");
