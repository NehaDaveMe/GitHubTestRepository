...
public class Report_ContractorDeductTrackingOld_Test extends BaseClass {

	WebDriverCommonLib wb = new WebDriverCommonLib();
	String selectReportName = "Contractor Deduct Tracking";
	String headerName = "Contractor Insurance Cost Tracking";//Contractor Deduct Tracking
	String headerName2 = "Contractor Deduct Tracking";//
	...
	public void testContractorDeductTrackingOld(String ProgramName, String Division, String Projects, String userName,
		...
		/*	Assert.assertEquals(Report_ContractorDeductTrackingOld.reportHeaderReportName(driver).getText(),
			...
			String reportName=Report_ContractorDeductTrackingOld.reportHeaderReportName(driver).getText();
