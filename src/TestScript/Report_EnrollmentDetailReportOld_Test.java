...
public class Report_EnrollmentDetailReportOld_Test extends BaseClass {
	WebDriverCommonLib wb = new WebDriverCommonLib();
	String selectReportName = "Enrollment Detail Report";
	String headerName = "Enrollment Detail Report";
	String headerName2="Enrollment Detail";
	...
	public void testEnrollmentDetailReportOld(String ProgramName, String Division, String Projects, String userName,
		...
		try {
			...
			String reportName=Report_EnrollmentDetailReportOld.reportHeaderReportName(driver).getText();
