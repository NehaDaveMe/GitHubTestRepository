...
public class EnrollContractorWithouExcel_Test extends BaseClass 
{
	WebDriverCommonLib wb = new WebDriverCommonLib();
//	AddContractor_Pkg_TC tc = new AddContractor_Pkg_TC();
	
	public String contractorName = "Alex Comp1903";//Alex Comp3524";
	public String projectName = "Sony Projects3524";
	String programName = "Sony Programs3524";// "Sony Tower One Prog";
	String contractorCompany = "Alex Comp1903";//Alex Comp3524";// "sony";
	...
	public String cpStartDate="05/01/2021";
	public String cpEndDate="08/02/2024";
	
	
	@Test
	public void enrollContractorTest() throws InterruptedException, IOException 
	{
		 String contractorPKGno = RandomClass.randomContractorPkgNo();
		 System.out.println("Contractor Package Number::   "+contractorPKGno);
...
//		WPO_SelectContractorPkgAction.selectContractorpkg(contractorPKGno, "Test");
		...
		AddContractor_Pkg_Insurance_Enrollment_Page.fieldEstimatedStartDate(driver).sendKeys(cpStartDate, Keys.TAB);
		...
		AddContractor_Pkg_Insurance_Enrollment_Page.fieldEstimatedCompletionDate(driver).sendKeys(cpEndDate,
				Keys.TAB);
...
//		id="btnSaveModal"
		...
		String autoITpath="./AutoIT Script/Neha_PDF.exe";
		Runtime.getRuntime().exec(autoITpath);
//		/WrapPortalAzure/AutoIT Script/FileUpload.exe
