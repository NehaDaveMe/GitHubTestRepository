...
public class Report_ContractorStandingReport_Test extends BaseClass {
	WebDriverCommonLib wb = new WebDriverCommonLib();
	String selectReportName = "Contractor Standing Report";
	String reportName = "Contractor Standing Report";

	@Test(dataProvider = "excelData")
	public void testContractorStandingReport(String ProgramName, String Division, String Projects, String userName,
		...
		try {
			...
			Thread.sleep(5000);
			Report_ContractorStandingReport.selectReport(driver, selectReportName).click();
		...
		try {
			...
			test.log(LogStatus.PASS,
					"Program Name:- " + Report_ContractorStandingReport.programName(driver).getText());
			test.log(LogStatus.PASS,
					"Sponsor Name:- " + Report_ContractorStandingReport.sponsorName(driver).getText());

			 test.log(LogStatus.PASS, "Project Name:- " +Report_ContractorStandingReport.projectName(driver).getText());

			test.log(LogStatus.PASS,
					"Time Stamp:- " + Report_ContractorStandingReport.timeStamp(driver).getText());
			test.log(LogStatus.PASS, "Excel Option is Present:- "
					+ Report_ContractorStandingReport.exportToExcel(driver).isDisplayed());
...
//		String filePath = "E:\\kp workspace selenium\\Wrap Portal\\testData\\clientWiseReportTestData.xlsx";
		...
		// Portal-2\\testData\\LocktonReportData2.xlsx";
	...
	public void testCount(int projectSize, int contPkgSize) {
		...
		List<WebElement> countOfProject = Report_ContractorStandingReport.countProjectNames(driver);
		List<WebElement> countOfContractorPkg = Report_ContractorStandingReport
