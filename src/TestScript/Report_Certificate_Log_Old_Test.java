...
public class Report_Certificate_Log_Old_Test extends BaseClass {
	...
	String selectReportName = "Certificate Log ";//IOA have 1 space in name
	...
	public void testProjectSummaryReportOld(String ProgramName, String Division, String Projects, String userName,
		...
		try {
			...
			System.out.println(driver.findElement(By.xpath("//span[@id='lblReportName']")).getText());
			Assert.assertEquals(driver.findElement(By.xpath("//span[@id='lblReportName']")).getText(),
					"Certificate Log");
