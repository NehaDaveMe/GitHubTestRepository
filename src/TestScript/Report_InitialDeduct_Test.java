...
public class Report_InitialDeduct_Test extends BaseClass {
...
//			WPO_LoginActionClientWise.logInLockton(driver);
			...
			try {
				wb.selectSingleValue(Report_InitialDeduct.filterSelectDivisionDropdown(driver), Division);
...
//		testCount(contPkgSize);
		...
		wb.selectSingleValueByIndex(Report_InitialDeduct.selectAnFilterDropdown(driver), 2);
		Thread.sleep(3000);
