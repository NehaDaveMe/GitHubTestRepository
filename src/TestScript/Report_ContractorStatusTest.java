...
public class Report_ContractorStatusTest extends BaseClass
{
...
//	String project2 = "712 West Peachtree";
	...
	public void testContractorStatus(String ProgramName, String Division, String Projects,String userName, String password ,String ProjectNAME1,String ProjectNAME2) throws InterruptedException
	{
	try 
	{	
//		WPO_LoginActionClientWise.logInLockton(driver);
		...
		try {
			wb.selectSingleValue(Report_ContractorStatus.filterSelectDivisionDropdown(driver), Division);
			test.log(LogStatus.PASS,Division+ " Selected Successfully");	
		} catch (Throwable e) {
			System.out.println(e);
		}
		
		Report_ContractorStatus.filterSelectProjectFormOption(driver, Projects).click();
