...
public class Report_EstimatedEndDatesTest extends BaseClass {
...
//			WPO_LoginActionClientWise.logInLockton(driver);
			...
			try {
				wb.selectSingleValue(Report_EstimatedEndDates.filterSelectDivisionDropdown(driver), Division);
				test.log(LogStatus.PASS, Division + " Selected Successfully");	
			} catch (Throwable e) {
				System.out.println(e);
			}
			
			Report_EstimatedEndDates.filterSelectProjectFormOption(driver, Projects).click();
