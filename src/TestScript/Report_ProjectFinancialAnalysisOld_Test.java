...
public class Report_ProjectFinancialAnalysisOld_Test extends BaseClass {
	...
	String selectReportName = "Project Financial Analysis  ";//1 space in the report name,2 space in norioa
	String selectReportName2 = "Project Financial Analysis ";

	@Test(dataProvider = "excelData")
	public void testProjectFinancialAnalysisReport(String ProgramName, String Division, String Projects, String userName,
		...
		Thread.sleep(10000);
		if (wb.isFileDownloaded("Project_Financial_Analysis.xls") == true) {
