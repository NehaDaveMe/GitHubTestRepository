...
public class Report_SponsorProjectDetailTest extends BaseClass {
	WebDriverCommonLib wb = new WebDriverCommonLib();
//	String selectReportName = "Sponsor Project Detail"; 
	String selectReportName = "Sponsor Program Detail";
	String reportHeader="Sponsor Program Detail";
//	String project1 = "120 Piedmont Student Housing";
//	String project2 = "712 West Peachtree";	
	
	
	@Test(dataProvider = "excelData")
	public void testSponsorProjectDetail(String ProgramName, String Division, String Projects,String userName, String password ,String ProjectNAME1,String ProjectNAME2 )
...
//			WPO_LoginActionClientWise.logInLockton(driver);
			...
			try {
				wb.selectSingleValue(Report_SponsorProjectDetail.filterSelectDivisionDropdown(driver), Division);
...
//		testCount(contPkgSize);
		...
		if (wb.isFileDownloaded("Sponsor_Project_Detail.xls") == true) {
