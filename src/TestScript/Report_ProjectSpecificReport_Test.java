...
public class Report_ProjectSpecificReport_Test extends BaseClass
{	
	WebDriverCommonLib wb=new WebDriverCommonLib();
	String selectReportName="Project Specific Report";
	String reportNameHeader="Project Specific Report";

	String selectReportName2="Program Specific Report";
	String reportNameHeader2="Program Specific Report";
...
//		WPO_LoginActionClientWise.logInWTW(driver);
	try 
	{
		...
		try {
			...
			ReportModule.selectReport(driver, selectReportName2).click();
			test.log(LogStatus.PASS, selectReportName+ " Report is Selected");
		}
...
System.out.println(e);
	...
	try {
		...
		String reportName=Report_ProjectSpecificReportCard.reportHeaderReportName(driver).getText();
		if(reportName.contains(reportNameHeader) || reportName.contains(reportNameHeader2))
		{
			System.out.println("Report Name is Matched");
			test.log(LogStatus.PASS, "Report Header Name Matched");
		}else
