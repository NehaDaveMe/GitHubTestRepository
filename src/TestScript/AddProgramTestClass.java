...
public class AddProgramTestClass extends BaseClass 
{
	...
	String selectProgramAdministrator=""+usercompanyName+" - John1 Tom1";//String selectProgramAdministrator="User1012 - John1 Tom1";//"Alex Contractor Comp1834 - Hobs Shobs";//"Sony User Company - K p"
	String selectProgramSponsor="Sponsor347 - Jimmy Smith";//"Sponsor1395 - Jimmy Smith";//"AutoNation - kim canada"
	
/*	String selectProgramAdministrator="Alex Contractor Comp1834 - Hobs Shobs";//"Sony User Company - K p"
	String selectProgramSponsor="Sponsor1395 - Jimmy Smith";//"AutoNation - kim canada"
*/
	
	@Test()
	public void addGeneralInformationData() throws InterruptedException, IOException
	{
...
//add administrator hyper link	23/07/20
		...
		Thread.sleep(2000);
//		AddProgram_General_Info_Page.contractorCompanyNameField(driver).sendKeys(RandomClass.randomContractorCompanyName());
...
//		AddProgram_General_Info_Page.contactFirstName(driver).click();
...
//add new Sponsor hyper link 23/07/20	
		...
		//now when you enter the company name more filed automatically gets open
//		AddProgram_General_Info_Page.MoreButton(driver).click();
//		test.log(LogStatus.PASS, "Clicked On More Button");
...
//add logo through AutoIT 23/07/2020
		Runtime.getRuntime().exec("./AutoIT Script/Program_UploadLogo.exe");
...
//Add Excluded Trade 23/07/20 		
		...
		Thread.sleep(2000);
		driver.manage().window().maximize();
		AddClassCodePage.addClassCodeWorkClassDescriptionField(driver).sendKeys(RandomClass.randomTradeDescription_EX());
		...
		driver.switchTo().window(wb.map.get("childID"));
		Thread.sleep(5000);
		AddProgram_Program_Parameters_Page.descriptionWorkClassField(driver).sendKeys("Test Class Code Description");
		Thread.sleep(1000);
...
// because of changes below code is comment they add this functionality at payroll cv tracking 24/07/20 changes done
		...
		driver.manage().window().maximize();
		Thread.sleep(2500);
		AddProgram_Program_Parameters_Page.addSuspendedPayrollStartDate(driver).sendKeys("11/01/2019", Keys.TAB);
		test.log(LogStatus.PASS, "Suspended Payroll Start Date Added Successfully");
		AddProgram_Program_Parameters_Page.addSuspendedPayrollEndDate(driver).sendKeys("12/31/2019", Keys.TAB);
		test.log(LogStatus.PASS, "Suspended Payroll End Date Added Successfully");
		AddProgram_Program_Parameters_Page.addSuspendedPayrollNotes(driver).click();
...
//		AddProgram_Policy_Certificates_Page.selectOtherPolicyForAdd(driver, "Automobile Liability Policy").click();
		...
		AddProgram_Policy_Certificates_Page.addOtherPolicyFieldMasterPolicy(driver).sendKeys("Master Policy No"+ RandomClass.randomProgramCode());
		...
		test.log(LogStatus.PASS, "Estimated Completion Date on Contractor Certificate Selected Successfully");
		js.executeScript("arguments[0].click();",AddProgram_Policy_Certificates_Page.addOtherPolicySaveAndCloseBtn(driver));
...
//Add Others Policies buildersRisk 24/07/2020	
		js.executeScript("arguments[0].click();",AddProgram_Policy_Certificates_Page.AddOtherPoliciesToListBtn(driver));
		Thread.sleep(2000);
		test.log(LogStatus.PASS, "Clicked on Click Here Link to add Other Policy");
...
//Policy Renewal //CREATE A NEW SEPRATE SCRIPT FOR IT EDIT PROGRAM POLICY RENEWAL
		...
		js.executeScript("arguments[0].click();", AddProgram_Policy_Certificates_Page.GL_RenewPolicySaveAndContinueButton(driver));
		...
		AddProgram_Policy_Certificates_Page.newPolicyNumberGenerateCertificatesSendEmailToTextField(driver).sendKeys("kiran@nourtek.com");
		js.executeScript("arguments[0].click();", AddProgram_Policy_Certificates_Page.newPolicyNumberGenerateCertificatesSendEmailSendBtn(driver));	
		Thread.sleep(3000);
		AddProgram_Policy_Certificates_Page.newPolicyNumberGenerateCertificatesSendEmailSendBtn_OK_Alert(driver).click();
		driver.switchTo().window(wb.map.get("childID"));*/
...
//Fixed Cost And Rates Tab		
		...
		wb.selectSingleValueByIndex(AddProgram_Fixed_Costs_Rates_Page.programRatesAndDeductiblesSelectRateDescription(driver), 2);
		AddProgram_Fixed_Costs_Rates_Page.programRatesAndDeductiblesRateField(driver).sendKeys("2000");
		wb.selectSingleValueByIndex(AddProgram_Fixed_Costs_Rates_Page.programRatesAndDeductiblesSelectRateBase(driver), 2);
		wb.selectSingleValueByIndex(AddProgram_Fixed_Costs_Rates_Page.programRatesAndDeductiblesSelectRateBaseType(driver),1);
...
public void editProgram() throws InterruptedException 
{
	...
	HomePage.controlMenuHomeIcon(driver).click();
	test.log(LogStatus.PASS, " has been Passed");
	HomePage.HomeMenuPrograms(driver).click();
	Thread.sleep(2000);
