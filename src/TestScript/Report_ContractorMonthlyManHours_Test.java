...
public class Report_ContractorMonthlyManHours_Test extends BaseClass
{
...
//			Report_ContractorMonthlyManHours.filterSelectProjectFormOption(driver, "Sony Project One").click();
			...
			wb.selectSingleValue(Report_ContractorMonthlyManHours.selectFromDate(driver), "Apr - 2018");
			test.log(LogStatus.PASS, " From Date Selected Successfully");
			wb.selectSingleValue(Report_ContractorMonthlyManHours.selectToDate(driver), "Dec - 2020");
