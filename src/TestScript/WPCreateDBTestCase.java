	...
	public void testCreateDB_WP() throws Throwable
	{
		...
		for(int i=0;i<=moduleName.size()-1;i++)
		{
			...
			case "AddDistrict":
				...
				wb.mouseMoveToElement(HomePage.userProfileIcon(driver));
//				HomePage.userProfileIcon(driver).click();
				
				wb.waitForElemnet(HomePage.HomeMenuSettings(driver));
//				HomePage.HomeMenuSettings(driver).click();
//				Thread.sleep(5000);
				
				wb.waitForElemnet(SettingsModules.settingsMenuDivisionsModule(driver));
//				SettingsModules.settingsMenuDivisionsModule(driver).click();
				...
				do {
					try {	
							...
							System.out.println("Alert Present and Accepted");
							test.log(LogStatus.PASS, "Alert Present and Accepted");
							Random ran = new Random();
							int rNo = ran.nextInt(100000);
							String newtradeNumber="Divi"+rNo;
							String newDiviName="Division" +rNo;
							Thread.sleep(1000);
							AddDivisonPage.addDivisionDivisionNameField(driver).clear();
							AddDivisonPage.addDivisionDivisionNameField(driver).sendKeys(newDiviName);
							test.log(LogStatus.PASS, "Division Name Added Successfully");
							AddDivisonPage.addDivisionDivisionCodeField(driver).clear();
							Thread.sleep(1000);
							AddDivisonPage.addDivisionDivisionCodeField(driver).sendKeys(RandomClass.randomDivisionCode());
							test.log(LogStatus.PASS, "Division Code Added Successfully");
							AddDivisonPage.addDivisionSaveAndContinueBtn(driver).click();
...
//				js.executeScript("arguments[0].click();",SettingsModules.settingsModuleButton(driver));
				...
				Thread.sleep(1500);
				AddUserPage.requiredInfoAlertCloseBtn(driver).click();
				test.log(LogStatus.PASS, "Required Field Alert Accepted");
				Thread.sleep(500);
				wb.selectSingleValue(AddUserPage.selectSecurityProfile(driver), "General User");
				test.log(LogStatus.PASS, "User Profile Selected Successfully");
				Thread.sleep(500);
				AddUserPage.addUserSaveAndContinueBtn(driver).click();
				test.log(LogStatus.INFO, "Clicked On Save And Continue Button");
				...
				test.log(LogStatus.INFO, "Clicked On Address Save And Close Button");
				driver.switchTo().window(wb.map.get("childID"));
				AddUserPage.addUserAddressTabSaveAndContinueBtn(driver).click();
				test.log(LogStatus.INFO, "Clicked On Add Address Save And Continue Button");
			...
			case "AddSponsors":
				...
				Thread.sleep(6000);*/
				wb.waitForElemnet(SettingsModules.settingsMenuMySponsorsModule(driver));
				test.log(LogStatus.INFO, "Clicked On Sponsor Module Icon");
				Thread.sleep(6000);
				wb.waitForElemnet(SponsorsModule.SponsorAddIcon(driver));
//				SponsorsModule.SponsorAddIcon(driver).click();
				...
				test.log(LogStatus.PASS, "Required Field Alert Accepted");
				Thread.sleep(1000);
				wb.selectSingleValue(AddUserPage.selectSecurityProfile(driver), "Primary Sponsor");
				test.log(LogStatus.PASS, "Security Profile Selected Successfully");
				Thread.sleep(500);
			...
			case "AddContractors":
				...
				wb.waitForElemnet(HomePage.controlMenuContractor(driver));
				Thread.sleep(6000);
				wb.waitForElemnet(ContractorModule.contractorAddIcon(driver));
//				ContractorModule.contractorAddIcon(driver).click();
				...
				test.log(LogStatus.PASS, "Required Field Alert Accepted");
				Thread.sleep(500);
				wb.selectSingleValue(AddContractorPage.selectSecurityProfile(driver), "General Contractor");
				test.log(LogStatus.PASS, "Security Profile Selected Successfully");
				Thread.sleep(500);
...
//				js.executeScript("arguments[0].click();",SettingsModules.settingsModuleButton(driver));
				...
				*/
				...
				Thread.sleep(6000);
				wb.waitForElemnet(CarriersModule.carriersAddIcon(driver));
//				CarriersModule.carriersAddIcon(driver).click();
			...
			case "AddProject":
				...
				wb.waitForElemnet(SettingsModules.settingsMenuProjectModule(driver));
				...
				wb.selectSingleValue(AddProject_General_Information_Page.selectProgramField(driver), programName);//Sony Tower Test
...
//				test.log(LogStatus.PASS, "Project Code Added Successfully");
			...
			//single multi prime functionality remove	
			/*	wb.selectSingleValueGetOpt(AddProject_General_Information_Page.selectProjectAdministrator(driver), usercompanyName);
				test.log(LogStatus.PASS, "Project Administrator Selected Successfully");
				System.out.println("Document Switch \t"+AddProject_General_Information_Page.requiredDocumentsforEnrollmentSwitch(driver).isEnabled());
				System.out.println("Portal Switch \t"+AddProject_General_Information_Page.activateContractorPortalForThisProjectSwitch(driver).isEnabled());
				AddProject_General_Information_Page.singlePrimeRedioButton(driver).isEnabled();
				
				AddProject_General_Information_Page.searchGeneralContractorCompanyField(driver).sendKeys(ContractorCompanyName);//Contractor name
				Thread.sleep(2000);
				...
				AddProject_General_Information_Page.searchContactField(driver).sendKeys(ContractorCompanyName);//contractor name
				Thread.sleep(2000);
...
*/
		...
		//Project Setting		
			...
			//contacts  Tab
				...
				wb.selectSingleValue(AddProject_Contact_Page.addNewContactsSelectSecurityGroup(driver), "General User");
				test.log(LogStatus.PASS, "Security Profile Added Successfully");
				...
				Thread.sleep(3000);
				//now its by default selected
//				wb.waitForElemnet(AddProject_Contact_Page.addNewContactsGrantUserAccessCheckBox(driver));
...
//				test.log(LogStatus.PASS, "Contact Grant User Access Successfully");
				...
				test.log(LogStatus.PASS, "Certificate Company Name Token Added Successfully");
				AddProject_Certificate_Page.selectProgramNameToken(driver).click();
				test.log(LogStatus.PASS, "Certificate Program Name Token Added Successfully");
				...
				JavascriptExecutor js = (JavascriptExecutor) driver;
				js.executeScript("arguments[0].click();",AddProject_Certificate_Page.projectSpecificPolicyRadioBtn(driver));
				test.log(LogStatus.INFO, "Selected Project Specific Policy Radio Button");
//				WebElement element=AddProject_Certificate_Page.projectSpecificPolicyRadioBtn(driver);//now change to radio button
...
//				AddProject_Certificate_Page.addUmbPolSaveAndCloseBtn(driver).click();
			...
			/*	
				WebElement element1=AddProject_Certificate_Page.enterSecondPageCertificateTextifrequiredSwitch(driver);
				...
				element1.click();
				test.log(LogStatus.INFO, "Clicked On Second Page Certificate Switch");
				...
				AddProject_Certificate_Page.secondCertificateDetailsTextAreaBold(driver).click();
				AddProject_Certificate_Page.secondCertificateSelectProgramNameToken(driver).click();
				test.log(LogStatus.PASS, "Program Name Token Added Successfully");
				AddProject_Certificate_Page.secondCertificateSelectProjectNameToken(driver).click();
				Thread.sleep(1000);
				test.log(LogStatus.PASS, "Project Name Token Added Successfully");
...
//				AddProject_Certificate_Page.additionalNameInsuredAddbutton(driver).click();
				...
				wb.selectSingleValueByIndex(AddProject_Certificate_Page.additionalNameInsuredSelectAdditionalNameInsured(driver), 9);
				test.log(LogStatus.PASS, "Insured Additional Name Selected Successfully");
				AddProject_Certificate_Page.additionalNameInsuredSearchForInsuranceCompany(driver).sendKeys("ABC insurance");
				Thread.sleep(2000);
				AddProject_Certificate_Page.additionalNameInsuredSearchForInsuranceCompany(driver).sendKeys(Keys.TAB);
				AddProject_Certificate_Page.additionalNameInsuredSearchForInsuranceCompany(driver).sendKeys(Keys.TAB);
				test.log(LogStatus.PASS, "Additional Name Insurance Company Added Successfully");
//				AddProject_Certificate_Page.additionalNameInsuredTextAreaBold(driver).click();
				AddProject_Certificate_Page.additionalNameInsuredSelectCompanyNameToken(driver).click();
				test.log(LogStatus.PASS, "Additional Insured Company Name Token Added Successfully");
				AddProject_Certificate_Page.additionalNameInsuredSelectProgramNameToken(driver).click();
				test.log(LogStatus.PASS, "Additional Insured Program Name Token Added Successfully");
...
//				test.log(LogStatus.PASS, "Program Code Added Successfully");
				...
				wb.selectSingleValueGetOpt(AddProgram_General_Info_Page.selectProgramAdministrator(driver),usercompanyName);//9
...
//				test.log(LogStatus.PASS, "Contract Number Sequence Added Successfully");
				...
				Thread.sleep(5000);
				wb.waitForElemnetMax(AddProgram_Email_Management_Page.emailManagementSaveAndContinueButton(driver));
				js.executeScript("window.scrollBy(0,4000)");
				Thread.sleep(2000);
				js.executeScript("arguments[0].click();",AddProgram_Email_Management_Page.emailManagementSaveAndContinueButton(driver));
				test.log(LogStatus.INFO, "Clicked On Email Management Save And Continue Button");
				...
				/*AddProgram_Contractor_Portal_Options_Page.switchRequestSubinfoAtEnrollment(driver).click();
				test.log(LogStatus.PASS, "Request Sub Info at Enrollment Switch Turn On Successfully");
			
				AddProgram_Contractor_Portal_Options_Page.switchAllowContractorToAddSub(driver).click();
				test.log(LogStatus.PASS, "Allow Contractor To Add New Sub Switch Turn On Successfully");
				AddProgram_Contractor_Portal_Options_Page.switchAllow_GC_AddContractorNumber(driver).click();
				test.log(LogStatus.PASS, "Allow General Contractor to add Contract Number Switch Turn On Successfully");
				AddProgram_Contractor_Portal_Options_Page.switchAllow_SubContractor_AddContractorNumber(driver).click();
				test.log(LogStatus.PASS, "Allow Sub Contractor to add Contract Number  Switch Turn On Successfully");
				*/
				...
				wb.selectSingleValueByIndex(AddProgram_User_Access.selectNodeAdministratorDropdown(driver),1);//select another user 
				Thread.sleep(2000);
				...
				{
					System.out.println(e+"Exception handel for alert");
				}*/
...
/*				AddProgram_Compliance_Page.addCompliancePlusIcon(driver).click();
				...
				driver.switchTo().window(wb.map.get("subchildID"));
				wait.until(ExpectedConditions.visibilityOf(AddProgram_Compliance_Page.addComplianceComplianceName(driver)));
				wait.until(ExpectedConditions.elementToBeClickable(AddProgram_Compliance_Page.addComplianceComplianceName(driver)));
				AddProgram_Compliance_Page.addComplianceComplianceName(driver).sendKeys("Compliance29");
				Thread.sleep(1000);
				AddProgram_Compliance_Page.selectCheckBoxForCompliance(driver, "Automobile Liability").click();
				Thread.sleep(1000);
			//	AddProgram_Compliance_Page.addFirstRowLimitText(driver, "Automobile Liability").sendKeys("1000");
				Thread.sleep(1000);
//				AddProgram_Compliance_Page.addSecondRowLimitText(driver, "Automobile Liability").sendKeys("1000");
//				Thread.sleep(1000);
				AddProgram_Compliance_Page.selectCheckBoxForCompliance(driver, "General Liability").click();
				Thread.sleep(1000);
				//AddProgram_Compliance_Page.addFirstRowLimitText(driver, "General Liability").sendKeys("1000");
				Thread.sleep(1000);
//				AddProgram_Compliance_Page.addSecondRowLimitText(driver, "General Liability").sendKeys("1000");
				
				AddProgram_Compliance_Page.selectCheckBoxForCompliance(driver, "Umbrella / Excess").click();
				Thread.sleep(1000);
				//AddProgram_Compliance_Page.addFirstRowLimitText(driver, "Umbrella / Excess").sendKeys("1000");
				
				AddProgram_Compliance_Page.selectCheckBoxForCompliance(driver, "Workers' Compensation").click();
				Thread.sleep(1000);
				AddProgram_Compliance_Page.addFirstRowLimitText(driver, "Workers' Compensation").sendKeys("1000");
				Thread.sleep(1000);
				AddProgram_Compliance_Page.addCompliancenoteTextArea(driver).sendKeys("Testing Note Area");
				Thread.sleep(1000);
				js.executeScript("arguments[0].scrollIntoView();",AddProgram_Compliance_Page.addComplianceSaveAndCloseButton(driver));
				AddProgram_Compliance_Page.addComplianceSaveAndCloseButton(driver).click();
				wait.until(ExpectedConditions.visibilityOf(AddProgram_Compliance_Page.addComplianceAlertOkBtn(driver)));
				wait.until(ExpectedConditions.elementToBeClickable(AddProgram_Compliance_Page.addComplianceAlertOkBtn(driver)));
				AddProgram_Compliance_Page.addComplianceAlertOkBtn(driver).click();
				driver.switchTo().window(wb.map.get("childID"));
			...
			/*	AddProgram_Premium_Modification_Page.switchGLCodesRequired(driver).click();
				test.log(LogStatus.PASS, "General Liability Codes Required Switch is Turned ON");
				...
				AddProgram_Premium_Modification_Page.switchPollutionCodesRequired(driver).click();
				test.log(LogStatus.PASS, "Pollution Codes Required Switch is Turned ON");*/
...
//				test.log(LogStatus.PASS, "Profit & Overhead Switch is Turned ON");
				...
				AddProgram_Policy_Certificates_Page.addWCPolicyFieldMasterPolicy(driver).sendKeys("Master Policy No"+ RandomClass.randomProgramCode());
				...
				wb.getWindowID3();
				driver.switchTo().window(wb.map.get("subchildID"));
				wb.selectSingleValue(AddProgram_Policy_Certificates_Page.addGLPolicySelectCarrier(driver), carrierName);
				test.log(LogStatus.PASS, "GL Policy Carrier Selected Successfully");
				AddProgram_Policy_Certificates_Page.addGLPolicyFieldMasterPolicyEditBox(driver).sendKeys("Master GL Pol"+RandomClass.randomProgramCode());
				...
				test.log(LogStatus.PASS, "UMB Policy Layer Selected Successfully");
				AddProgram_Policy_Certificates_Page.addUmbPolEnterPolicyNumberField(driver).sendKeys("MasterUMB POL "+RandomClass.randomProgramCode());
...
//				js.executeScript("window.scrollBy(0,250)");
				js.executeScript("arguments[0].scrollIntoView();",AddProgram_Policy_Certificates_Page.addUmbPolSaveAndCloseBtn(driver));
				driver.switchTo().window(wb.map.get("childID"));
			...
			case "AddTrade":
				...
				wb.waitForElemnet(HomePage.HomeMenuSettings(driver));
				Thread.sleep(5000);
				wb.waitForElemnet(SettingsModules.settingsMenuTradesModule(driver));
//				Thread.sleep(5000);
//				SettingsModules.settingsMenuTradesModule(driver).click();
				Thread.sleep(5000);
			...
			/*	HomePage.controlMenuHomeIcon(driver).click();
				...
				wb.waitForElemnet(SettingsModules.settingsMenuClassCodeModule(driver));
				Thread.sleep(3000);
...
//				WebDriverWait wait=new WebDriverWait(driver, 60);
				System.out.println("Program Name-" +programName +"\t Project Name-"+projectName+ "\t EnrollmentType-" +EnrollmentType +"\t ContractorName-"+ContractorCompanyName+"\t tradeName-" +tradeName );
				...
				wait.until(ExpectedConditions.elementToBeClickable(AddContractor_Pkg_Page.selectEnrollmentType(driver)));
				...
				wb.selectSingleValueFromList(AddContractor_Pkg_Page.SelectContactAutoCompllete(driver),ContrContactFirstName+" "+ContractorContactLastName);
				test.log(LogStatus.PASS, ContrContactFirstName+ContractorContactLastName+ " Contact added successfully");
