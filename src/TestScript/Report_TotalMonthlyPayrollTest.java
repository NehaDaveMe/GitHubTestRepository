...
public class Report_TotalMonthlyPayrollTest extends BaseClass {
...
//	String project2 = "712 West Peachtree";
	...
	public void testTotalMonthlyPayroll(String ProgramName, String Division, String Projects,String userName, String password ,String ProjectNAME1,String ProjectNAME2 ) throws Throwable {
		try {
//			WPO_LoginActionClientWise.logInLockton(driver);
			...
			try {
				wb.selectSingleValue(Report_TotalMonthlyPayroll.filterSelectDivisionDropdown(driver), Division);
				test.log(LogStatus.PASS, Division + " Selected Successfully");	
			} catch (Throwable e) {
				System.out.println(e);
			}
			
			Report_TotalMonthlyPayroll.filterSelectProjectFormOption(driver, Projects).click();
