...
public class Report_PayrollComparisonTest extends BaseClass {
...
//	String project2 = "712 West Peachtree";
	...
	public void testPayrollComparison(String ProgramName, String Division, String Projects,String userName, String password ,String ProjectNAME1,String ProjectNAME2 )
...
//			WPO_LoginActionClientWise.logInLockton(driver);
			...
			try {
				wb.selectSingleValue(Report_PayrollComparison.filterSelectDivisionDropdown(driver), Division);
...
//		testCount(contPkgSize);
		...
		//pdf option is removed
		/*// Check for pdf is generated or not take screenshot
		Report_PayrollComparison.pdfLink(driver).click();
