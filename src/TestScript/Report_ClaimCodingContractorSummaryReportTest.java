...
public class Report_ClaimCodingContractorSummaryReportTest extends BaseClass {
	...
	public void testClaimsCodingContractorSummaryReport(String ProgramName, String Division, String Projects,String userName, String password , String ProjectNAME1,String ProjectNAME2)
...
//			WPO_LoginActionClientWise.logInLockton(driver);
			...
			try {
				wb.selectSingleValue(Report_ClaimsCodingContractorSummaryReport.filterSelectDivisionDropdown(driver),
						Division);
