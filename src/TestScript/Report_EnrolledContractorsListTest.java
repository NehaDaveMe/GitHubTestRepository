...
public class Report_EnrolledContractorsListTest extends BaseClass {
...
//		testCount(contPkgSize);
		...
		wb.selectSingleValueByIndex(Report_EnrolledContractorsList.selectAnFilterDropdown(driver), 2);
		Thread.sleep(3000);
