...
public class Report_PayrollNonCompliacnReport_Test extends BaseClass 
{
	...
	public void testPayrollNonCIPReport(String ProgramName, String Division, String Projects,String userName, String password, String ProjectNAME1,String ProjectNAME2)
		...
		try {
			...
			wb.selectSingleValue(Report_PayrollNonCompliacnReport.filterSelectProjectFormOption(driver), Projects);
...
//		String filePath = "./testData/LocktonReportData2.xlsx";
