...
public class Report_FinalDeductTest extends BaseClass
{
...
//			WPO_LoginActionClientWise.logInLockton(driver);
			...
			try {
				wb.selectSingleValue(Report_FinalDeduct.filterSelectDivisionDropdown(driver), Division);
...
//		testCount(contPkgSize);
		...
		wb.selectSingleValueByIndex(Report_FinalDeduct.selectAnFilterDropdown(driver), 2);
		Thread.sleep(3000);
