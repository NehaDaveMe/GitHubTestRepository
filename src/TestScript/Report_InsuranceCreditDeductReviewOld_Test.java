...
public class Report_InsuranceCreditDeductReviewOld_Test extends BaseClass 
{
	
	WebDriverCommonLib wb = new WebDriverCommonLib();
	String selectReportName = "Insurance Credit Deduct Review";
	String headerName = "Insurance Credit Deduct Review";
	...
	public void testInsuranceCreditDeductReviewOld(String ProgramName, String Division, String Projects,String userName, String password ,String ProjectNAME1,String ProjectNAME2)
		...
		try {
			...
			wb.selectSingleValue(Report_InsuranceCreditDeductReviewOld.selectProjects(driver), Projects);
