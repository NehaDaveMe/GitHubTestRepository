...
public class Report_OpenActionItems_Test extends BaseClass {
	...
	public void testOpenActionItemReport(String ProgramName, String Division, String Projects, String userName,
		...
		try {
			...
			try {
				wb.selectSingleValue(Report_OpenActionItems.filterSelectProjectFormOption(driver), Projects);
				test.log(LogStatus.PASS, Projects + " Project Selected Successfully");
				//lipscomb use location instead of project
			} catch (Throwable e) {
				System.out.println(e);
			}
		...
		/*	test.log(LogStatus.PASS, "Program Name:- " + Report_OpenActionItems.programName(driver).getText());
			 ...
			 * Report_OpenActionItems.allColumnName(driver); //
			 * wb.printListData(); for (int i = 0; i < list.size(); i++) {
