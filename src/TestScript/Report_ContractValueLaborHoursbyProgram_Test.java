...
public class Report_ContractValueLaborHoursbyProgram_Test extends BaseClass {

	WebDriverCommonLib wb = new WebDriverCommonLib();
//	String selectReportName = "Contract Value & Labor Hours by Program";
...
//	String project2 = "712 West Peachtree";
	...
	public void testContractValueLaborHoursbyProgram(String ProgramName, String Division, String Projects,String userName, String password ,String ProjectNAME1,String ProjectNAME2)
			throws Throwable {
		try {
...
//			WPO_LoginActionClientWise.logInLockton(driver);
			...
			try {
				wb.selectSingleValue(Report_ContractValueLaborHoursbyProgram.filterSelectDivisionDropdown(driver),
						Division);
		...
		if (wb.isFileDownloaded("Contract_Value__Labor_Hours_by_Program.xls") == true) {
