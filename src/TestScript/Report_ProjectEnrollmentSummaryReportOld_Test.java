...
public class Report_ProjectEnrollmentSummaryReportOld_Test extends BaseClass {
	...
	public void testProjectSummaryReportOld(String ProgramName, String Division, String Projects, String userName,
		...
		try {
			...
			System.out.println(driver.findElement(By.xpath("//b[contains(text(),'Project Enrollment Summary')]")).getText());
			Assert.assertEquals(driver.findElement(By.xpath("//b[contains(text(),'Project Enrollment Summary')]")).getText(),
