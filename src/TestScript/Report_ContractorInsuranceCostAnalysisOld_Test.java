...
public class Report_ContractorInsuranceCostAnalysisOld_Test extends BaseClass {
	...
	public void testContractorInsuranceCostAnalysisOld(String ProgramName, String Division, String Projects,
		...
		try {
			...
			try {
				wb.selectSingleValue(Report_ContractorInsuranceCostAnalysisOld.selectDivision(driver), Division);
