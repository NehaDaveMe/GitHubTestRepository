...
public class Report_ContractorRosterReportOld_Test extends BaseClass {
	...
	public void testContractorRosterReportOld(String ProgramName, String Division, String Projects, String userName,
		...
		try {
			...
			try {
				wb.selectSingleValue(Report_ContractorRosterReportOld.selectDivision(driver), Division);
				test.log(LogStatus.PASS, " Divisions Selected Successfully");
				Thread.sleep(3000);
			} catch (Throwable e) {
				System.out.println(e);
			}
			wb.selectSingleValue(Report_ContractorRosterReportOld.selectProjects(driver), Projects);
