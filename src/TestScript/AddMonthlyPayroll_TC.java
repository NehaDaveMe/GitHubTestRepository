...
public class AddMonthlyPayroll_TC extends BaseClass {
	...
	public void testAdminMonthlyPayroll() throws Throwable {
		...
		/*
		 * String ProjectName = "Test 132 ON"; String TradeNo = "465"; String
		 * TradeName = "Trade for test"; String ContractorName =
		 * "Alex Comp1903"; String EnrollmentType = "WC & GL Enrollment";
		 */
		 ...
		 * Thread.sleep(10000); JavascriptExecutor js = (JavascriptExecutor)
		 * driver; js.executeScript("window.scrollBy(0,-350)", ""); do { try {
		 ...
		 * test.log(LogStatus.INFO, "Clicked On Search Icon"); x=2; } catch
