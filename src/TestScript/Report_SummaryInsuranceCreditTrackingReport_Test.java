...
public class Report_SummaryInsuranceCreditTrackingReport_Test extends BaseClass {
	...
	public void testProjectSpecificReport(String ProgramName, String Division, String Projects, String userName,
		...
		try {
			...
			System.out.println(driver.findElement(By.xpath("//th[contains(text(),'Summary Insurance Credit Tracking Report')]")).getText());
			softAssertion.assertEquals(driver.findElement(By.xpath("//th[contains(text(),'Summary Insurance Credit Tracking Report')]")).getText(),
					reportNameHeader);
