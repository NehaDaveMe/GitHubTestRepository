...
public class TaskValidationClassCodeTest extends BaseClass{
	...
	public void validateContractorPackage() throws Throwable
	{
		...
		Thread.sleep(2000);
		test.log(LogStatus.INFO, "Clicked On Control Menu Class Code Icon");
		driver.switchTo().frame(0);
		ContractorPackageModule.TaskIconActivityPanel(driver).click();
		test.log(LogStatus.PASS, "Clicked on Class Code Activity Panel Task Icon ");
		Thread.sleep(2000);
