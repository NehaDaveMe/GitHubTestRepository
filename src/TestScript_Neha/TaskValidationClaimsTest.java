...
public class TaskValidationClaimsTest extends BaseClass{
	...
	{
		HomePage.ClaimsIcon(driver).click();
		Thread.sleep(2000);
		test.log(LogStatus.INFO, "Clicked On Control Menu ClaimsIcon");
		driver.switchTo().frame(0);
		ContractorPackageModule.TaskIconActivityPanel(driver).click();
		test.log(LogStatus.PASS, "Clicked on ClaimsIcon ");
		Thread.sleep(2000);
