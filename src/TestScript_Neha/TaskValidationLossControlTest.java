...
public class TaskValidationLossControlTest extends BaseClass{
	...
	{
		HomePage.controlMenuLossControl(driver).click();
		Thread.sleep(2000);
		test.log(LogStatus.INFO, "Clicked On Control Menu Loss control Package Icon");
		driver.switchTo().frame(0);
		ContractorPackageModule.TaskIconActivityPanel(driver).click();
		test.log(LogStatus.PASS, "Clicked on Loss control Package Activity Panel Task Icon ");
		Thread.sleep(2000);
