...
public class TaskValidationTradesTest extends BaseClass {
	...
	public void validateContractorPackage() throws Throwable
	{
		...
		Thread.sleep(2000);
		HomePage.TradesIcon(driver).click();
		Thread.sleep(2000);
		test.log(LogStatus.INFO, "Clicked On TradesIcon");
		driver.switchTo().frame(0);
		ContractorPackageModule.TaskIconActivityPanel(driver).click();
		test.log(LogStatus.PASS, "Clicked on TradesIcon ");
		Thread.sleep(2000);
