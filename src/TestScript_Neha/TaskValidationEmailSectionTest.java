...
public class TaskValidationEmailSectionTest extends BaseClass {
	...
	public void validateContractorPackage() throws Throwable
	{
		...
		Thread.sleep(2000);
		test.log(LogStatus.INFO, "Clicked On Control Menu Email Icon");
		driver.switchTo().frame(0);
		ContractorPackageModule.TaskIconActivityPanel(driver).click();
		test.log(LogStatus.PASS, "Clicked on Control Menu Email Icon ");
		Thread.sleep(2000);
