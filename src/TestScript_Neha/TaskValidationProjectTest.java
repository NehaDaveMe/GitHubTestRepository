...
public class TaskValidationProjectTest extends BaseClass{
	...
	public void validateContractorPackage() throws Throwable
	{
		...
		Thread.sleep(2000);
		test.log(LogStatus.INFO, "Clicked On Control Menu Project Package Icon");
		driver.switchTo().frame(0);
		ContractorPackageModule.TaskIconActivityPanel(driver).click();
		test.log(LogStatus.PASS, "Clicked on Project Package Activity Panel Task Icon ");
		Thread.sleep(2000);
