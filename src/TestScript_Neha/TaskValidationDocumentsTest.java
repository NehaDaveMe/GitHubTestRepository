...
public class TaskValidationDocumentsTest extends BaseClass{
	...
	{
		HomePage.DocumentsIcon(driver).click();
		Thread.sleep(2000);
		test.log(LogStatus.INFO, "Clicked On Control Menu DocumentsIcon");
		driver.switchTo().frame(0);
		ContractorPackageModule.TaskIconActivityPanel(driver).click();
		test.log(LogStatus.PASS, "Clicked on DocumentsIcon Activity Panel Task Icon ");
		Thread.sleep(2000);
