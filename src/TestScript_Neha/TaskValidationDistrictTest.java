...
public class TaskValidationDistrictTest extends BaseClass{
	...
	public void validateContractorPackage() throws Throwable
	{
		...
		Thread.sleep(2000);
		HomePage.DistrictIcon(driver).click();
		Thread.sleep(2000);
		...
		test.log(LogStatus.PASS, "Clicked on Contractor Package Activity Panel Task Icon ");
		Thread.sleep(2000);
