...
public class TaskValidationNotesTest extends BaseClass {
	...
	{
		HomePage.NotesIcon(driver).click();
		Thread.sleep(2000);
		test.log(LogStatus.INFO, "Clicked On Control Menu NotesIcon");
		driver.switchTo().frame(0);
		ContractorPackageModule.TaskIconActivityPanel(driver).click();
		test.log(LogStatus.PASS, "Clicked on  NotesIcon");
		Thread.sleep(2000);
