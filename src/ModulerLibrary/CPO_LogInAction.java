...
public class CPO_LogInAction extends BaseClass {
	public static String uName = "JimmySmith114540";//JimmySmith114211";//"JimmySmith113888";//"JimmySmith114211";// "JimmySmith90022";
	public static String password = "aF9H7y2N9XaO";//"aF9H7y2N9XaO";//uX6R1i0L7KxA";//"uO5J6h4K1UdS";//uX6R1i0L7KxA";// "Cs2t4Q ";
	public static String url="https://cp.getenrolled.us/Login/welcome.aspx";//"https://preprod.getenrolled.us/Login/welcome.aspx";//https://www.locktonwrap.com/Login/welcome.aspx";
	
	public static void logInCPO(WebDriver driver) throws Throwable {
		
		driver.navigate().to("https://cp.getenrolled.us/");//("https://preprod.getenrolled.us/");
