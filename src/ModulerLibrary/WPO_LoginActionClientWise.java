...
public class WPO_LoginActionClientWise extends BaseClass {
	...
	public static String Url = "https://beta.wrapportal.com/";// "https://beta.wrapportal.com/";
...
//			System.out.println("can't login " + errorMsg);
	...
	public static void logInCommon(WebDriver driver, String uName, String pass) throws Throwable {
		WebDriverCommonLib wb = new WebDriverCommonLib();
		JavascriptExecutor js = (JavascriptExecutor) driver;

		wb.mouseMoveToElementwithoutClick(HomePage.userProfileIcon(driver));
		js.executeScript("arguments[0].click();", HomePage.userProfileIcon(driver));
		js.executeScript("arguments[0].click();", HomePage.HomeMenuLogoutBtn(driver));
		Thread.sleep(3000);
		...
		test.log(LogStatus.PASS, pass + " Password Entered Successfully");
