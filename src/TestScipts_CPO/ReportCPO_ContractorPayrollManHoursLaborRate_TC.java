...
{
	//report is not present. if presnet then need to create the pom class first for this report 
	...
	{		
			...
			try {
				...
				Assert.assertEquals(Report_CPO_ContractorDeductTracking.reportHeader(driver).getText(), "Contractor Payroll, Man-Hours & Labor Rate");
