...
public class CPO_Add_ChangeOrder_Test extends BaseClass {
	...
	public void testChangeOrder() throws Throwable {
		...
		String effectiveDate="04/01/2021";
		String completionDate="04/01/2022";
		...
		CPO_Add_ChangeOrder.effectiveDate(driver).sendKeys(effectiveDate, Keys.TAB);
		test.log(LogStatus.INFO, " Effective Date Added Successfully");
		
		CPO_Add_ChangeOrder.newEstCompletionDate(driver).sendKeys(completionDate, Keys.TAB);
