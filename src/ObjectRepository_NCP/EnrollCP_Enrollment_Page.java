...
//	static String WCClassCodeDropDown="//div[@class='select-wrapper mdb-select md-form colorful-select dropdown-primary form-control-dynamic ddlWorkClass']//ul/li[*]";
	...
	static String selectGLClassCode = "//div[@class='div-additional-gl']/table[1]//label[@class='active'][contains(text(),'Class Code')]/../div";
	static String selectGLClassCodeFromList = "//div[@class='div-additional-gl']/table[1]//label[@class='active'][contains(text(),'Class Code')]/../div/ul/li";// list
	static String glradioBtnUncappedPayroll = "//div[@class='row div-liability-details']//div[@class='div-additional-gl']/table[1]/tbody/tr[2]/td[1]/table/tbody/tr[1]/td[1]/div/label";
	static String glradioBtnContractValue = "//div[@class='row div-liability-details']//div[@class='div-additional-gl']/table[1]/tbody/tr[2]/td[1]/table/tbody/tr[2]/td[1]/div/label";
	static String glradioBtnSelfPerformPrice = "//div[@class='row div-liability-details']//div[@class='div-additional-gl']/table[1]/tbody/tr[2]/td[1]/table/tbody/tr[3]/td[1]/div/label";
	static String glradioBtnSubContractorCost = "//div[@class='row div-liability-details']//div[@class='div-additional-gl']/table[1]/tbody/tr[2]/td[1]/table/tbody/tr[4]/td[1]/div/label";
	static String glradioBtnWorkerCompensation = "//div[@class='row div-liability-details']//div[@class='div-additional-gl']/table[1]/tbody/tr[2]/td[1]/table/tbody/tr[5]/td[1]/div/label";
	static String glradioBtnFlatPremium = "//div[@class='row div-liability-details']//div[@class='div-additional-gl']/table[1]/tbody/tr[2]/td[1]/table/tbody/tr[7]/td[1]/div/label";
	static String glradioBtnPerUnit = "//div[@class='row div-liability-details']//div[@class='div-additional-gl']/table[1]/tbody/tr[2]/td[1]/table/tbody/tr[8]/td[1]/div/label";
	static String glradioBtnOther = "//div[@class='row div-liability-details']//div[@class='div-additional-gl']/table[1]/tbody/tr[2]/td[1]/table/tbody/tr[9]/td[1]/div/label";
	static String glselectRatePerUnitField = "//div[@class='row div-liability-details']//div[@class='div-additional-gl']/table[1]/tbody/tr[3]/td[1]//input";
	static String glselectRatePerUnit = "//div[@class='row div-liability-details']//div[@class='div-additional-gl']/table[1]/tbody/tr[3]/td[1]//ul/li";
	static String glselectRateField = "//div[@class='row div-liability-details']//div[@class='div-additional-gl']/table[1]/tbody/tr[4]/td[1]//input";
	static String btnAddGeneralLiability = "//div[@class='row div-liability-details']//div[@class='div-additional-gl']/../div[2]//a";
	static String AddGeneralLiabilitySaveBtn = "//div[@class='row div-liability-details']//div[@class='div-additional-gl']/table[2]/tbody/tr[5]/td//button[2]";
	static String AddGeneralLiabilityCancelBtn = "//div[@class='row div-liability-details']//div[@class='div-additional-gl']/table[2]/tbody/tr[5]/td//button[1]";
	...
	public static WebElement selectGLClassCode(WebDriver driver, int GL_No) {
		element = driver.findElement(By.xpath("//div[@class='div-additional-gl']/table['" + GL_No
				+ "']//label[@class='active'][contains(text(),'Class code / Description')]/../div"));
		return element;//update the xpath class code / description changed
	}

	public static List<WebElement> selectGLClassCodeFromList(WebDriver driver, int GL_No) {
		listElement = driver.findElements(By.xpath("//div[@class='div-additional-gl']/table['" + GL_No
				+ "']//label[@class='active'][contains(text(),'Class code / Description')]/../div/ul/li"));
		return listElement;
	}

	public static WebElement glradioBtnUncappedPayroll(WebDriver driver, int GL_No) {
		element = driver.findElement(By
				.xpath("//div[@class='row div-liability-details']//div[@class='div-additional-gl']/table['"
	...
	public static WebElement btnAddGeneralLiability(WebDriver driver, int GL_No) {
		element = driver.findElement(By.xpath(
				"//div[@class='row div-liability-details']//div[@class='div-additional-gl']/../div[2]//a"));
		return element;
	}
	...
	static String selectUMBClassCode = "//div[@class='div-additional-umbrella']/table[1]//label[@class='active'][contains(text(),'Class code / Description')]/../div";

	public static WebElement selectUMBClassCode(WebDriver driver, int GL_No) {
		element = driver.findElement(By.xpath("//div[@class='div-additional-umbrella']/table['"+GL_No+"']//label[@class='active'][contains(text(),'Class code / Description')]/../div"));
		return element;
	}

	static String selectUMBClassCodeFromList = "//div[@class='div-additional-umbrella']/table[1]//label[@class='active'][contains(text(),'Class code / Description')]/../div/ul/li";

	public static List<WebElement> selectUMBClassCodeFromList(WebDriver driver, int GL_No) {
		listElement = driver.findElements(By.xpath("//div[@class='div-additional-umbrella']/table['"
				+ GL_No + "']//label[@class='active'][contains(text(),'Class code / Description')]/../div/ul/li"));
		return listElement;
	}

	static String umbradioBtnUncappedPayroll = "//div[@class='row div-liability-details']//div[@class='div-additional-umbrella']/table[1]/tbody/tr[2]/td[1]/table/tbody/tr[1]/td[1]/div/label";

	public static WebElement umbradioBtnUncappedPayroll(WebDriver driver, int GL_No) {
		element = driver.findElement(By
				.xpath("//div[@class='row div-liability-details']//div[@class='div-additional-umbrella']/table['"
						+ GL_No + "']/tbody/tr[2]/td[1]/table/tbody/tr[1]/td[1]/div/label"));
		return element;
	}

	static String umbradioBtnContractValue = "//div[@class='row div-liability-details']//div[@class='div-additional-umbrella']/table[1]/tbody/tr[2]/td[1]/table/tbody/tr[2]/td[1]/div/label";
	...
	static String umbradioBtnSelfPerformPrice = "//div[@class='row div-liability-details']//div[@class='div-additional-umbrella']/table[1]/tbody/tr[2]/td[1]/table/tbody/tr[3]/td[1]/div/label";
	...
	static String umbradioBtnSubContractorCost = "//div[@class='row div-liability-details']//div[@class='div-additional-umbrella']/table[1]/tbody/tr[2]/td[1]/table/tbody/tr[4]/td[1]/div/label";
	...
	static String umbradioBtnWorkerCompensation = "//div[@class='row div-liability-details']//div[@class='div-additional-umbrella']/table[1]/tbody/tr[2]/td[1]/table/tbody/tr[5]/td[1]/div/label";
	...
	static String umbradioBtnFlatPremium = "//div[@class='row div-liability-details']//div[@class='div-additional-umbrella']/table[1]/tbody/tr[2]/td[1]/table/tbody/tr[7]/td[1]/div/label";
	...
	static String umbradioBtnPerUnit = "//div[@class='row div-liability-details']//div[@class='div-additional-umbrella']/table[1]/tbody/tr[2]/td[1]/table/tbody/tr[8]/td[1]/div/label";
	...
	static String umbradioBtnOther = "//div[@class='row div-liability-details']//div[@class='div-additional-umbrella']/table[1]/tbody/tr[2]/td[1]/table/tbody/tr[9]/td[1]/div/label";
	...
	static String umbselectRatePerUnitField = "//div[@class='row div-liability-details']//div[@class='div-additional-umbrella']/table[1]/tbody/tr[3]/td[1]//input";
	...
	static String umbselectRatePerUnit = "//div[@class='row div-liability-details']//div[@class='div-additional-umbrella']/table[1]/tbody/tr[3]/td[1]//ul/li";
	...
	static String umbselectRateField = "//div[@class='row div-liability-details']//div[@class='div-additional-umbrella']/table[1]/tbody/tr[4]/td[1]//input";
	...
	static String btnAddUmbrellaLiability = "//div[@class='row div-liability-details']//div[@class='div-additional-umbrella']/../div[2]//a";

	public static WebElement btnAddUmbrellaLiability(WebDriver driver, int GL_No) {
		element = driver.findElement(By.xpath(
				"//div[@class='row div-liability-details']//div[@class='div-additional-umbrella']/../div[2]//a"));
		return element;
	}

	static String AddUmbrellaLiabilitySaveBtn = "//div[@class='row div-liability-details']//div[@class='div-additional-umbrella']/table[2]/tbody/tr[5]/td//button[2]";
	...
	static String AddUmbrellaLiabilityCancelBtn = "//div[@class='row div-liability-details']//div[@class='div-additional-umbrella']/table[2]/tbody/tr[5]/td//button[1]";
	...
	static String selectPollClassCode = "//div[@class='div-additional-pollution']/table[1]//label[@class='active'][contains(text(),'Class code / Description')]/../div";

	public static WebElement selectPollClassCode(WebDriver driver, int GL_No) {
		element = driver.findElement(By
				.xpath("//div[@class='div-additional-pollution']/table['"+GL_No+"']//label[@class='active'][contains(text(),'Class code / Description')]/../div"));
		return element;
	}

	static String selectPollClassCodeFromList = "//div[@class='div-additional-pollution']/table[1]//label[@class='active'][contains(text(),'Class code / Description')]/../div/ul/li";

	public static List<WebElement> selectPollClassCodeFromList(WebDriver driver, int GL_No) {
		listElement = driver.findElements(By.xpath("//div[@class='div-additional-pollution']/table['"
				+ GL_No + "']//label[@class='active'][contains(text(),'Class code / Description')]/../div/ul/li"));
		return listElement;
	}

	static String pollradioBtnUncappedPayroll = "//div[@class='row div-liability-details']//div[@class='div-additional-pollution']/table[1]/tbody/tr[2]/td[1]/table/tbody/tr[1]/td[1]/div/label";

	public static WebElement pollradioBtnUncappedPayroll(WebDriver driver, int GL_No) {
		element = driver.findElement(By
				.xpath("//div[@class='row div-liability-details']//div[@class='div-additional-pollution']/table['"
						+ GL_No + "']/tbody/tr[2]/td[1]/table/tbody/tr[1]/td[1]/div/label"));
		return element;
	}

	static String pollradioBtnContractValue = "//div[@class='row div-liability-details']//div[@class='div-additional-pollution']/table[1]/tbody/tr[2]/td[1]/table/tbody/tr[2]/td[1]/div/label";
	...
	static String pollradioBtnSelfPerformPrice = "//div[@class='row div-liability-details']//div[@class='div-additional-pollution']/table[1]/tbody/tr[2]/td[1]/table/tbody/tr[3]/td[1]/div/label";
	...
	static String pollradioBtnSubContractorCost = "//div[@class='row div-liability-details']//div[@class='div-additional-pollution']/table[1]/tbody/tr[2]/td[1]/table/tbody/tr[4]/td[1]/div/label";
	...
	static String pollradioBtnWorkerCompensation = "//div[@class='row div-liability-details']//div[@class='div-additional-pollution']/table[1]/tbody/tr[2]/td[1]/table/tbody/tr[5]/td[1]/div/label";
	...
	static String pollradioBtnFlatPremium = "//div[@class='row div-liability-details']//div[@class='div-additional-pollution']/table[1]/tbody/tr[2]/td[1]/table/tbody/tr[7]/td[1]/div/label";
	...
	static String pollradioBtnPerUnit = "//div[@class='row div-liability-details']//div[@class='div-additional-pollution']/table[1]/tbody/tr[2]/td[1]/table/tbody/tr[8]/td[1]/div/label";
	...
	static String pollradioBtnOther = "//div[@class='row div-liability-details']//div[@class='div-additional-pollution']/table[1]/tbody/tr[2]/td[1]/table/tbody/tr[9]/td[1]/div/label";
	...
	static String pollselectRatePerUnitField = "//div[@class='row div-liability-details']//div[@class='div-additional-pollution']/table[1]/tbody/tr[3]/td[1]//input";
	...
	static String pollselectRatePerUnit = "//div[@class='row div-liability-details']//div[@class='div-additional-pollution']/table[1]/tbody/tr[3]/td[1]//ul/li";
	...
	static String pollselectRateField = "//div[@class='row div-liability-details']//div[@class='div-additional-pollution']/table[1]/tbody/tr[4]/td[1]//input";
	...
	static String btnAddPollutionLiability = "//div[@class='row div-liability-details']//div[@class='div-additional-pollution']/../div[2]//a";

	public static WebElement btnAddPollutionLiability(WebDriver driver, int GL_No) {
		element = driver.findElement(By.xpath(
				"//div[@class='row div-liability-details']//div[@class='div-additional-pollution']/../div[2]//a"));
		return element;
	}

	static String AddPollutionLiabilitySaveBtn = "//div[@class='row div-liability-details']//div[@class='div-additional-pollution']/table[2]/tbody/tr[5]/td//button[2]";
	...
	static String AddPollutionLiabilityCancelBtn = "//div[@class='row div-liability-details']//div[@class='div-additional-pollution']/table[2]/tbody/tr[5]/td//button[1]";
