...
public class Report_NCP_ProgramFinancialAnalysisReport
{
	...
	// calculation Xpath
		static String takeAllEstimatedValue = "//input[@id='ctrlInsuranceEnrollment_txtSelfContractValue' or @id='ctrlInsuranceEnrollment_txtPayrolls']";// AddContractor_WC_Premiums_Modifications_Page.premiumValues(driver);
