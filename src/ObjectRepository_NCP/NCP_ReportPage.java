...
public class NCP_ReportPage {
	...
	static String selectProgramFromList = "//div[@class='select-wrapper mdb-select md-form colorful-select dropdown-primary ddl-report-project']//span[@class='caret']/../ul/li";// list
