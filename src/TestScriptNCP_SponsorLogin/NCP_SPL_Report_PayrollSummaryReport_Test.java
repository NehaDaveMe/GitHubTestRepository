...
public class NCP_SPL_Report_PayrollSummaryReport_Test extends BaseClass {
	...
	public void testEnrollmentStatusReport(String ProgramName, String Division, String Projects) throws Throwable {
		...
		try {
			...
			wb.selectSingleValue(Report_PayrollSummaryReport.filterSelectProjectFormOption(driver), Projects);
			test.log(LogStatus.PASS, Projects + " Project Selected Successfully");

			wb.selectSingleValue(Report_PayrollSummaryReport.filterSelectContractorFormOption(driver),
					"All Contractors");
