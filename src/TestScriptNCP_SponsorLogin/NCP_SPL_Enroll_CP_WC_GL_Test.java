...
//		wb.waitForElementTOBeClickble(NCP_HomePage.selectPreviewPanelProjectDropdown(driver, contractorName));
...
//GL Page		
		...
		// UMB Page
		// wb.waitForElemnet(EnrollCP_Enrollment_Page.selectUMBClassCode(driver,
		// 1));
		js.executeScript("window.scrollBy(0,250)", "");
		js.executeScript("arguments[0].scrollIntoView();", EnrollCP_Enrollment_Page.selectUMBClassCode(driver, 1));
		test.log(LogStatus.PASS, " Clicked on UMB Class Code Field");
		...
		test.log(LogStatus.INFO, "Clicked On GL Umbrella Mark as Confirmed Radio Button");
		js.executeScript("window.scrollBy(0,300)");
		js.executeScript("arguments[0].click();", AddContractor_Pkg_GL_Umbrella_Coverage_Page.btnSaveAndClose(driver));
		test.log(LogStatus.INFO, "Clicked On GL Umbrella Save And Continue Button");
		Thread.sleep(6000);*/
