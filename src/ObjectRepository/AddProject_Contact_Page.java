...
//	"//select[@id='ddlSecurity']";
	...
	static String addNewContactsGrantUserAccessCheckBox = "//input[@id='chkUserAccess']";//"//input[@id='chkUserAccess']";
	static String addNewContactsUserAccessAccountSetupCompleteCheckBox = "//input[@id='chkAccountSetupComplete']";//input[@id='chkAccountSetupComplete']
	static String addNewContactsUserAccessAutoGenerateButton = "//a[@id='aAutoGenerate']";//a[@id='aAutoGenerate']
	...
	static String addNewContactsUserAccessTabSaveandCloseButton = "//input[@id='btnSaveandCloseUserAccess']";//input[@value='Save and Close']";
