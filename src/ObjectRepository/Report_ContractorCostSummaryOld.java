...
public class Report_ContractorCostSummaryOld 
{
	...
	public static List<WebElement> getModifiersValue(WebDriver driver,String ContractorPkgNo) {
		listElement = driver.findElements(By.xpath("//td[contains(text(),'"+ContractorPkgNo+"')]/..//following-sibling::tr[position()>23 and position()<31]/td[6]"));
		return listElement;
		//we directly fetch report name in method and use dynamic xpath to accepting report name through method
	}
	//td[contains(text(),'P3524CONTRACTOR_PKG_NO43235')]/..//following-sibling::tr[position()>23 and position()<31]/td[6]
