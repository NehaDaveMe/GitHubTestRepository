...
public class Report_ProgramDeductionRateAnalysisOld 
{
	...
	//calculation xapth column wise
	
	static String columContractorSelfPerformTotal ="td[contains(text(),'Contract #')]/../following-sibling::tr[position()<last()-13]/td[6]";
	public static List<WebElement> columContractorSelfPerformTotal(WebDriver driver) {
		listElement = driver.findElements(By.xpath(columContractorSelfPerformTotal));
		return listElement;
	}
...
//	static String selectContractorPkg ="//span[contains(text(),'ContractroPkgNo')]";
	...
	public static List<WebElement> selectWCModifiersValue(WebDriver driver, String contrPkgNo) {
		listElement = driver.findElements(By.xpath("//td[contains(text(),'"+contrPkgNo+"')]/../td[position()>5 and position()<8]"));
		return listElement;
	}
