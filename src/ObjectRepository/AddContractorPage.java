...
public class AddContractorPage {
	...
	static String addContractorSaveAndCloseBtn = "//div[@class='fright']//button[2]"; //input[@id='cntrlAddUpdateContractor_btnSaveandClose']
	...
	static String selectSecurityProfile = "//select[@id='ddlCompanyGroup']";
