...
public class Report_MissingPayrollReport {
	...
	static String selectFromMonth="//select[@id='ctrlBuildReport_ddlFromMonthYear']";
	static String selectToMonth="//select[@id='ctrlBuildReport_ddlToMonthYear']";
	
	
	static String selectReport = "//span[text()='+reportName+']";
	static String btnBuildReport = "//input[@id='ctrlBuildReport_btnBuildReport']";

	public static WebElement selectFromMonth(WebDriver driver) {
		element = driver.findElement(By.xpath(selectFromMonth));
		return element;
	}
	public static WebElement selectToMonth(WebDriver driver) {
		element = driver.findElement(By.xpath(selectToMonth));
		return element;
	}
