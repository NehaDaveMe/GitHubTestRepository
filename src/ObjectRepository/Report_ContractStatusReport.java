...
public class Report_ContractStatusReport 
{
	...
	//raja changed Xpath //kp changed the xpath 05/04/2021
	static String reportHeaderReportName="//table[@class='subTable tableHeader']/tbody/tr[2]/td[contains( text(),'Contract Status Report')]";//table[@class='subTable tableHeader']//tr/..//td[@class='mainTitle tcc' and text()='Contract Status Report  ']"; //"//td[@class='mainTitle txt-center']";
