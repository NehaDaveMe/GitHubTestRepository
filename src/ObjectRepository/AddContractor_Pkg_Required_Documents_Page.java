...
public class AddContractor_Pkg_Required_Documents_Page {
	...
	static String signEnrollmentDocumentLink ="//span[contains(text(),'Signed Enrollment Form')]";
	static String signEnrollmentDocumentLinkOpen ="//div[@id='divxyz']/a[1]";
	
	
	
	public static WebElement signEnrollmentDocumentLink(WebDriver driver) {
		element = driver.findElement(By.xpath(signEnrollmentDocumentLink));
		return element;
	}
	
	public static WebElement signEnrollmentDocumentLinkOpen(WebDriver driver) {
		element = driver.findElement(By.xpath(signEnrollmentDocumentLinkOpen));
		return element;
	}
