...
public class AddProject_Certificate_Page {
	...
	//update the xpath on 06/08/2021 again update for both project and for worksite
	static String addProjectSpecificPolicyButton = "//span[contains(text(),'Add Worksite Specific Policy ') or contains(text(),'Add Project Specific Policy ')]";//span[contains(text(),'Add Project Specific Policy ')]";
