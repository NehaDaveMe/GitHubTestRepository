...
public class Report_ContractorCloseOutTrackingOld 
{
	...
	static String reportHeaderReportName= "//span[contains(text(),'Deduct Details')]";//span[@id='Label1']";//span[@id='LblHeading']";
...
//	static String selectContractorPkg ="//span[contains(text(),'ContractroPkgNo')]";
	...
	public static List<WebElement> selectWCModifiersValue(WebDriver driver, String contrPkgNo) {
		listElement = driver.findElements(By.xpath("//td[contains(text(),'"+contrPkgNo+"')]/../td[position()>4 and position()<7]"));
		return listElement;
	}
...
/*	public static List<WebElement> estimatedValuesReport(WebDriver driver,String cpNo) {
		listElement = driver.findElements(By.xpath("//td[contains(text(),'"+cpNo+"')]/../td[position()>4 and position()<7]"));
		return listElement;
	}
	
	public static WebElement selectContractorPkg(WebDriver driver, String cpNo) {
		element = driver.findElement(By.xpath("//td[contains(text(),'"+cpNo+"')]"));
		return element;
	}
*/	
