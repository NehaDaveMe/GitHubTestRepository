...
public class AddProgram_General_Info_Page {
	...
	//-----------------Neha Start-------------------
		...
		static String SwitchesGeneralInfo = "//ul[@class='iosListing']/li[not( contains(@id,'divProfitOverhead'))][not(contains(@id,'divGLLossCharge'))][not(contains(@id,'LiTrackOSHRAndEMR'))]//div[@class='iosSwith']/div/span/div[@class='ios-ui-select checked' or 'ios-ui-select ']";
		static String  TrackExcludedContractor ="//div[@class='col-md-6 col-sm-6 iosSwitch']//ul/li[@id='divTrackExcludedContractor']//div[@id='uniform-chkTrackExcludedContractor']";
		
		//ul[@class='iosListing']/li[position()>1 and position()!=15]//*[@class='inner']
		
		public static List<WebElement> SwitchesGeneralInfo(WebDriver driver) {
			listElement = driver.findElements(By.xpath(SwitchesGeneralInfo));
			return listElement;
		}

		public static WebElement TrackExcludedContractor(WebDriver driver) {
			element = driver.findElement(By.xpath(TrackExcludedContractor));
			return element;
		}
