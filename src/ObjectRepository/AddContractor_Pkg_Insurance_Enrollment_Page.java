...
public class AddContractor_Pkg_Insurance_Enrollment_Page {
	...
	public static WebElement enrollContractorPkgAllTab(WebDriver driver,String tabName) {
		element = driver.findElement(By.xpath("//ul[@id='myTab']/li/a[@title='"+tabName+"']"));
		return element;
	}
	...
	// calculation Xpath
	static String takeAllEstimatedValue = "//input[@id='ctrlInsuranceEnrollment_txtContractPrice' or @id='ctrlInsuranceEnrollment_txtSelfContractValue' or @id='ctrlInsuranceEnrollment_txtPayrolls' or @id='ctrlInsuranceEnrollment_txtEstCapPayroll' or @id='ctrlInsuranceEnrollment_txtManHours']";// AddContractor_WC_Premiums_Modifications_Page.premiumValues(driver);
	...
	static String ContractorCompanyInsurancecost="//div[@class='panel panel-default']//div[@id='ctrlInsuranceEnrollment_divContractorInsuranceCost']//div[@class='title']";
	static String ContractValue = "//div[contains(text(),'Contract Value')]/../input[@id='ctrlInsuranceEnrollment_txtContractPrice']";
	static String SelfPerformedContractValue = "//div[contains(text(),'Self-performed Contract Value')]/../input[@id='ctrlInsuranceEnrollment_txtSelfContractValue']";
	static String EstimatedStartDate = "//div[contains(text(),'Estimated Start Date')]/../input[@id='ctrlInsuranceEnrollment_txtStartDate']";
	static String ScopeofWorktextarea = "//textarea[@id='ctrlInsuranceEnrollment_txtBrieflyDescribetheScopeWork']";
	
	public static WebElement ContractorCompanyInsurancecost(WebDriver driver) {	
		element = driver.findElement(By.xpath(ContractorCompanyInsurancecost));
		return element;
	}
	...
	public static WebElement ScopeofWorktextarea(WebDriver driver) {	
		element = driver.findElement(By.xpath(ScopeofWorktextarea));
		return element;
	}
	//----------------------------------------Neha End---------------------------------------
	
//	static String selectContractorPkg ="//span[contains(text(),'PC3524-P3524CONTRACTOR_PKG_NO43235')]"));
	
	static String locationCodeDuplicateAlertOKBtn="//button[@class='btn btn-primary pull-right']";
	static String locationCodeDuplicateAlertCancelBtn="//button[@id='btnCancelLocation']";
	static String locationCodeDuplicateAlertConfirmBtn="//button[@id='btnConfirm']";
	
	public static WebElement locationCodeDuplicateAlertCancelBtn(WebDriver driver) {
		element = driver.findElement(By.xpath(locationCodeDuplicateAlertCancelBtn));
		return element;
	}
	public static WebElement locationCodeDuplicateAlertConfirmBtn(WebDriver driver) {
		element = driver.findElement(By.xpath(locationCodeDuplicateAlertConfirmBtn));
		return element;
	}
	...
	static String alertCoomman ="//button[@id='btnSaveModal']";//id="btnSaveModal"
	...
	static String fieldContractorCompanyInsuranceCost ="//input[@id='ctrlInsuranceEnrollment_txtContractorInsuranceCost']";
...
//Enrollment Comparison	
	...
	public static WebElement fieldContractorCompanyInsuranceCost(WebDriver driver) {
		element = driver.findElement(By.xpath(fieldContractorCompanyInsuranceCost));
		return element;
	}
