...
public class Hompage_SubModules_Page {
	...
	//Certificates window 
		...
		static String Homepage_Submodules_AdvancesearchICon = "//a[@data-original-title='Advanced Search']";//"//a[@id='aAdvancedSearch']"; 
		static String Homepage_Submodules_SelectProgramme = "//select[@id='ctl00_ContentPlaceHolder1_ucClaimList_ddlProject']";//select[@id='ddlProject']";
		static String Homepage_Submodules_SelectTrade = "//input[@id='token-input-txtTradePackages']";
		static String Homepage_Submodules_SelectProject = "//select[@id='ctl00_ContentPlaceHolder1_ucClaimList_ddlWorkSite']";//select[@id='ddlWorkSite']";
