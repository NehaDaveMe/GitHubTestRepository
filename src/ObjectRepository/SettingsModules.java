...
public class SettingsModules {
	...
	static String settingsMenuFaxesModule = "//ul[@class='ulGreedy clearfix']/li[6]";//fax module remove
	static String settingsMenuMySponsorsModule = "//ul[@class='ulGreedy clearfix']/li[6]";
	static String settingsMenuProgramsModule = "//ul[@class='ulGreedy clearfix']/li[7]";
	static String settingsMenuDivisionsModule = "//ul[@class='ulGreedy clearfix']/li[8]";
	static String settingsMenuProjectModule = "//ul[@class='ulGreedy clearfix']/li[9]";
	static String settingsMenuClassCodeModule = "//ul[@class='ulGreedy clearfix']/li[10]";
	static String settingsMenuTradesModule = "//ul[@class='ulGreedy clearfix']/li[11]";
	static String settingsMenuCarriersModule = "//ul[@class='ulGreedy clearfix']/li[12]";
	static String settingsMenuCategoriesModule = "//ul[@class='ulGreedy clearfix']/li[13]";
	static String settingsMenuCustomFieldsModule = "//ul[@class='ulGreedy clearfix']/li[14]";
	static String settingsMenuMoreModule = "//ul[@class='ulGreedy clearfix']/li[15]";
