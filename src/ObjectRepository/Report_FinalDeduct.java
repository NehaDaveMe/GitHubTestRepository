...
//	static String selectContractorPkg ="//span[contains(text(),'ContractroPkgNo')]";
	public static WebElement selectContractorPkgID(WebDriver driver, String contrPkgNo) {
		element = driver.findElement(By.xpath("//span[contains(text(),'"+contrPkgNo+"')]"));
		return element;
	}
	
	public static List<WebElement> selectWCModifiersValue(WebDriver driver, String contrPkgNo) {
		listElement = driver.findElements(By.xpath("//span[contains(text(),'"+contrPkgNo+"')]/../..//following-sibling::tr[position()>6 and position()<14]/td[6]"));
		return listElement;
	}
