...
public class Report_InsuranceCreditDeductReviewOld 
{
	...
	static String linkExportToExcel ="//a[@id='HlinkExportExcel']";//a[@id='HlinkExportExcel']
	...
	public static WebElement selectContractorPkgID(WebDriver driver, String tradeNo) {
		element = driver.findElement(By.xpath("//td[contains(text(),'" + tradeNo + "')]"));
		return element;
	}

	public static List<WebElement> selectWCModifiersValue(WebDriver driver, String tradeNo) {
		listElement = driver.findElements(By.xpath("//td[contains(text(),'" + tradeNo + "')]/../td[position()=3]"));
		return listElement;
	}	
