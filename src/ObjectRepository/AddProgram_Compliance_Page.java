...
public class AddProgram_Compliance_Page 
{
	...
	static String addComplianceAlertOkBtn ="//button[@id='btnSaveModal']";//"//button[@class='btn btn-primary pull-right']";
	...
	{
		element=driver.findElement(By.xpath("//div[@class='fleft contractheadlink']/span[contains(text(),'"+liabilityName+"')]/../../div//input[@type='checkbox']"));
		return element;
	}
	//static String selectCheckBoxForCompliance="//div[@class='fleft contractheadlink']/span[contains(text(),'Automobile Liability')]/../../div//input[@type='checkbox']";

	public static WebElement addFirstRowLimitText(WebDriver driver, String liabilityName)
	{
		element=driver.findElement(By.xpath("//div[@class='fleft contractheadlink']/span[contains(text(),'"+liabilityName+"')]/../../div//input[@type='checkbox']/../../../../../../../following-sibling::div[1]//table/tbody/tr[1]/td[3]//input"));
		return element;
	}
	public static WebElement addSecondRowLimitText(WebDriver driver, String liabilityName)
	{
		element=driver.findElement(By.xpath("//div[@class='fleft contractheadlink']/span[contains(text(),'"+liabilityName+"')]/../../div//input[@type='checkbox']/../../../../../../../following-sibling::div[1]//table/tbody/tr[2]/td[3]//input"));
		return element;
	}
	
		//div[@class='fleft contractheadlink']/span[contains(text(),'Automobile Liability')]/../../div//input[@type='checkbox']/../../../../../../../following-sibling::div[1]//table/tbody/tr[1]/td[3]//input
