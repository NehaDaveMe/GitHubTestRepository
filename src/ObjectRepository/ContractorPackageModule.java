...
public class ContractorPackageModule {
	...
	static String fetchContractorPkgClosedOutStatusPriviewP ="//div[contains(text(),'Enrolled - Closed-Out')]";
...
//Certificate section
	...
	//--------------------------------Neha Start-------------------------------------------	
	//Activity Panel elements Task Icon
		
		static String TaskIcon = "//div/ul/li[@id='liTasks']/a";
		static String TxtSubject = "//div/div/input[@id='txtSubject']";
		static String AssignedTo = "//div/ul/li/input[@id='token-input-txtAssignedTo']";
		static String Submit = "//div/span[@id='spnSubmit']";
		static String StartDate = "//div/div/input[@id='txtStartDate']";
		static String EndDate = "//div/div/input[@id='txtEndDate']";
		static String Message = "//div/textarea[@id='txtWriteYourMessage']";
		...
		static String selectDropDownPriority = "//div[@class='controllGroups']/div/select[@id='ctrlActivity_ddlPriority']";
		static String selectDropDownStatus = "//div[@class='controllGroups']/div/div/select[@id='ctrlActivity_ddlTaskStatus']";
		
		static String ConfirmEnrolledRadioButton = "//div[@id='ctrlInsuranceEnrollment_divConfirmEnrolled']//div[@class='radio']";
		static String CheckConditionallyEnrolled ="//span[@id='divStatusIcon11']/i";
		//span[@id='divStatusIcon11']/i
		
		static String MarkAsConfirmed = "//div[@id='uniform-ctrlInsuranceEnrollment_rdoConfirm']/span";
		public static WebElement MarkAsConfirmed(WebDriver driver) {	
			element = driver.findElement(By.xpath(MarkAsConfirmed));
			return element;
		}

		static String CPlist = "//ul[@id='ulNoteList']/li";
		public static List<WebElement> CPlist(WebDriver driver) {
			listElement = driver.findElements(By.xpath(CPlist));
			return listElement;
		}
		
		public static WebElement CheckConditionallyEnrolled(WebDriver driver, String Company, String project,
				String Enrolltype, String Program, String Trade) {
			element = driver.findElement(
					By.xpath("//ul[@id='ulNoteList']/li[*]//div[@class='companytitle']/span[contains(text(),'" + Company
							+ "')]//..//..//..//div[@class='workSite']/span[contains(text(),'" + project
							+ "')]//..//..//..//..//div/span[contains(text(),'" + Enrolltype
							+ "')]//..//..//..//..//div[@class='statusType']//span[contains(text(),'" + Program
							+ "')]//..//..//..//..//..//div[@class='trade']/span[contains(text(),'" + Trade + "')]"));
			return element;
		}

		public static WebElement CheckEnrolledStatus(WebDriver driver, String Company, String project,
				String Enrolltype, String Enrollstatus ,String Program, String Trade) {
			element = driver.findElement(By.xpath(
					"//ul[@id='ulNoteList']/li[*]//div[@class='companytitle']/span[contains(text(),'"+Company
					+"')]//..//..//..//div[@class='workSite']/span[contains(text(),'"+project
					+"')]//..//..//..//..//div/span[contains(text(),'"+ Enrolltype
					+"')]//..//..//..//..//div[@class='statusType']//span[contains(text(),'"+Enrollstatus
					+"')]//..//..//span[contains(text(),'"+Program+"')]//..//..//..//..//..//div[@class='trade']/span[contains(text(),'"+Trade
					+"')]"));
			return element;
		}
		
		public static WebElement Previewpanelstatus(WebDriver driver, String Previewpanelstatus) {	
			element = driver.findElement(By.xpath("//div[@id='divMainPanel']//ul[@id='ulStatus']/li[@id]/div//div[@class='statusName' and contains(text(),'"+Previewpanelstatus+"')]"));
			return element;
		}
		public static WebElement ConfirmEnrolledRadioButton(WebDriver driver) {
			element = driver.findElement(By.xpath(ConfirmEnrolledRadioButton));
			return element;
		}
		...
		public static WebElement TxtSubject(WebDriver driver) {
			element = driver.findElement(By.xpath(TxtSubject));
			return element;
		}
		
		public static WebElement AssignedTo(WebDriver driver) {
			element = driver.findElement(By.xpath(AssignedTo));
			return element;
		}
		...
		public static WebElement StartDate(WebDriver driver) {
			element = driver.findElement(By.xpath(StartDate));
			return element;
		}
		...
		public static List<WebElement> selectDropDownPriority(WebDriver driver) {
			listElement = driver.findElements(By.xpath(selectDropDownPriority));
			return listElement;
		}
		
		public static List<WebElement> selectDropDownStatus(WebDriver driver) {
			listElement = driver.findElements(By.xpath(selectDropDownStatus));
			return listElement;
		}
		
		public static boolean nonCipComplianceANDMaintenanceWrap(WebDriver driver,String text) {
			b = driver.findElement(By.xpath("//div[@class='contractorstep1 clearfix']//div//a[contains(text(),'"+ text+"')]")).isDisplayed();
			return b;

			}
		
		public static boolean CIPCertificateANDTrackChangeOrder(WebDriver driver,String text) {
			b = driver.findElement(By.xpath("//div[@class='contractorstep2 clearfix']//div//a[contains(text(),'"+ text+"')]")).isDisplayed();
			return b;

			}
		
		public static boolean MaintenanceWrap(WebDriver driver) {
			b = driver.findElement(By.xpath("//div[@id='ctrlInsuranceEnrollment_divProjectMaintenance' and @style='display:block;']")).isDisplayed();
			return b;		
			//div[@class='panel-body clearfix']//div//div[contains(text(),'"+ text+"')]
			}
		
		public static boolean TrackFixedCostTimeandMaterial(WebDriver driver) {
			b = driver.findElement(By.xpath("//div[@id='ctrlInsuranceEnrollment_divFixedUnitPrice' and @style='display:block;']")).isDisplayed();
			//element = driver.findElement(By.xpath("//div[@id='ctrlInsuranceEnrollment_divFixedUnitPrice' and @style='display:block;']"));
			return b;
			//div[@class='panel-body clearfix']//div//span[contains(text(),'"+ text+"')]
			
			}
		
		public static Boolean trackExcludedContractors(WebDriver driver,String text) {
			b = driver.findElement(By.xpath("//div[@class='contractorstep1 clearfix']//div//a[contains(text(),'"+ text+"')]")).isDisplayed();
			return b;
			...
			//----------------------------------Neha End--------------------------
	public static WebElement fetchContractorPkgClosedOutStatusPriviewP(WebDriver driver) {
		element = driver.findElement(By.xpath(fetchContractorPkgClosedOutStatusPriviewP));
		return element;
	}
	...
	public static WebElement selectDynamicContractorPkg(WebDriver driver,String contractorName,String projectName,String tradeNo) {
		...
		element = driver.findElement(By.xpath("//ul[@id='ulNoteList']/li[*]//div[@class='companytitle']/span[contains(text(),'"+contractorName+"')]/../..//div[@class='workSite']/span[contains(text(),'"+projectName+"')]/../../../div[2]/div[3 and starts-with(@data-original-title,'"+tradeNo+"')]"));		
		return element;
		
		//ul[@id='ulNoteList']/li[*]//div[@class='companytitle']/span[contains(text(),'Alex Comp3524')]/../..//div[@class='workSite']/span[contains(text(),'Sony Projects3524')]/../../../div[2]/div[3 and starts-with(@data-original-title,'TNO97924')]
