...
//Navigations Links Xpaths of Preview Panel 10/08/2020
	...
	//--------------------------------Neha Start------------------------------------
	static String ProgramPreviewPanelFrame = "//iframe[@id='ifrmPreview']";
	public static WebElement ProgramPreviewPanelFrame(WebDriver driver) {
		element = driver.findElement(By.xpath(ProgramPreviewPanelFrame));
		return element;
	}
	static String ProgramPreviewStatuscheck="//div[@class='buttonGroupTop pull-right']/ul/li[@id='ctl21_liProjectStatus']";
	public static WebElement ProgramPreviewStatuscheck(WebDriver driver) {
		element = driver.findElement(By.xpath(ProgramPreviewStatuscheck));
		return element;
	}
