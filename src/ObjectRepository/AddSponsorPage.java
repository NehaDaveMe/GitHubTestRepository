...
public class AddSponsorPage {
	...
	static String userGroupOwnerOptionSelect = "//select[@id='ddlSecurity']/option[1]";//"//select[@id='ddlSecurity']";
	static String userGroupNoteArea = "//textarea[@id='txtUserNotes']";
	...
	public static WebElement userGroupOwnerOptionSelect(WebDriver driver) {
		element = driver.findElement(By.xpath(userGroupOwnerOptionSelect));
		return element;
	}
	public static WebElement userGroupNoteArea(WebDriver driver) {
		element = driver.findElement(By.xpath(userGroupNoteArea));
		return element;
	}
