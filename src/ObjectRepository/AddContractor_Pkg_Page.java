...
//			"//input[@id='token-input-cntrlAddUpdateContractor_txtGeneralContractor']";
	...
	static String addNewContractorLink = "//a[@id='cntrlAddUpdateContractor_aContractorPackages']";
...
//			"//input[@id='s2id_autogen6_search']/../../ul/li[*]";
	...
	static String TradeCheck = "//div[@class='title']/span[text()='Trade ']//..//span[@class]";
	
	public static WebElement TradeCheck(WebDriver driver) {
		element = driver.findElement(By.xpath(TradeCheck));
		return element;
	}
	
	static String TradeSearch="//div[@id='s2id_cntrlAddUpdateContractor_ddlTrade']/a";
	public static WebElement TradeSearch(WebDriver driver) {
		element = driver.findElement(By.xpath(TradeSearch));
		return element;
	}
	
	static String TradeDD = "//div[@id='select2-drop']/ul/li";
	public static List<WebElement> TradeDD(WebDriver driver) {
		listElement = driver.findElements(By.xpath(TradeDD));
		return listElement;
	}
	static String minRequirementEnrollmentAllowedSwitch ="//div[@id='uniform-cntrlAddUpdateContractor_chkConditionalEnrollment']//div[@class]";
	public static WebElement minRequirementEnrollmentAllowedSwitch(WebDriver driver) {
		element = driver.findElement(By.xpath(minRequirementEnrollmentAllowedSwitch));
		return element;
	}
	
	static String contracttypeDDtoverifyPreBid ="//div[@id='select2-drop']/div[1]//..//ul/li";
	public static List<WebElement> contracttypeDDtoverifyPreBid(WebDriver driver) {
		listElement = driver.findElements(By.xpath(contracttypeDDtoverifyPreBid));
		return listElement;
	}
	
	static String ContractTypeDDClickArrow ="//div[@id='s2id_cntrlAddUpdateContractor_ddlContractType']//span[@role='presentation']";
	public static WebElement ContractTypeDDClickArrow(WebDriver driver) {
		element = driver.findElement(By.xpath(ContractTypeDDClickArrow));
		return element;
	}
	
	static String PreviewlinkSection2 ="//div[@class='user_preview ']//div[@id='divMainPanel']//div[@class='whiteMainBox']//div[@id='divContractorStep2']/div//div/span/a";
	public static List<WebElement> PreviewlinkSection2(WebDriver driver) {
		listElement = driver.findElements(By.xpath(PreviewlinkSection2));
		return listElement;
	}
	
	static String PreviewlinkSection1 ="//div[@class='whiteMainBox']//div[@class='contractorstep1 clearfix']/div";
	public static List<WebElement> PreviewlinkSection1(WebDriver driver) {
		listElement = driver.findElements(By.xpath(PreviewlinkSection1));
		return listElement;
	}
	//div[@class='whiteMainBox']//div[@class='contractorstep3 clearfix']/div/div[@class='row']
	static String PreviewlinkSection3 ="//div[@class='whiteMainBox']//div[@class='contractorstep3 clearfix']/div/div[@class='row']/div/a";
	public static List<WebElement> PreviewlinkSection3(WebDriver driver) {
		listElement = driver.findElements(By.xpath(PreviewlinkSection3));
		return listElement;
	}
	
	static String lowertiercontractorcheck ="//div[@id='cntrlCompletionNotice_divrowPad25']/div";
	public static List<WebElement> lowertiercontractorcheck(WebDriver driver) {
		listElement = driver.findElements(By.xpath(lowertiercontractorcheck));
		return listElement;
	}
	
	static String selectContactList ="//div[@id='select2-drop']/ul/li[*]/div/span";
	
	public static List<WebElement> selectContactList(WebDriver driver) {
		listElement = driver.findElements(By.xpath(selectContactList));
		return listElement;
	}
		
	static String selectContactsearch ="//div[@id='s2id_cntrlAddUpdateContractor_ddlContacts']/a";
	
	public static WebElement selectContactsearch(WebDriver driver) {
		element = driver.findElement(By.xpath(selectContactsearch));
		return element;
	}
	
	//div[@id='cntrlAddUpdateContractor_divContractType']//div//div[@id='uniform-cntrlAddUpdateContractor_ddlContractType']/select[@id='cntrlAddUpdateContractor_ddlContractType']
	//div[@id='cntrlAddUpdateContractor_divContractType']//div//div[@id='uniform-cntrlAddUpdateContractor_ddlContractType']/select[@id='cntrlAddUpdateContractor_ddlContractType']
	/*
	 * static String contracttypeDDtoverifyPreBid1
	 * ="//div[@id='cntrlAddUpdateContractor_divContractType']//div//div[@id='uniform-cntrlAddUpdateContractor_ddlContractType']/select/option[@value='0']";
	 * public static WebElement contracttypeDDtoverifyPreBid1(WebDriver driver) {
	 * element = driver.findElement(By.xpath(contracttypeDDtoverifyPreBid1)); return
	 * element; }
	 */
	...
	static String plus_Btn = "//li[@id='ctl00_ContentPlaceHolder1_cntrlContractorList_liadd']";
	...
	static String Adv_search_Btn = "//a[@data-original-title='Advanced Search']";
