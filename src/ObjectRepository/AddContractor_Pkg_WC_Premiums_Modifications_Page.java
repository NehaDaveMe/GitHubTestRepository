...
public class AddContractor_Pkg_WC_Premiums_Modifications_Page
{
	...
	static String locationCodeField = "//input[@id='ctrlPremiumModes_txtLocationCode']";
	...
	static String premiumValues ="//tr[@id='divpremiumMod']//table/tbody/tr/td[5]/input[position()=1 and @value]";//"//tr[@id='divpremiumMod']//table/tbody/tr/td[5]/input[1]";//list
	static String premiumTotal ="//div[contains(text(),'Workers Compensation Premium')]/../../td[2]/input";
	
//	static String premiumValues ="//tr[@id='divpremiumMod']//table/tbody/tr/td[position()>4 and position()<6]/input[1]";//list
	
//	id="btnYes"
	static String zeroChargesAlert ="//button[id='btnYes']";
	
	public static WebElement zeroChargesAlert(WebDriver driver) {
		element = driver.findElement(By.xpath(zeroChargesAlert));
		return element;
	}
	
	public static List<WebElement> premiumValues(WebDriver driver) {
		listElement = driver.findElements(By.xpath(premiumValues));
		return listElement;
	}
	
	public static WebElement premiumTotal(WebDriver driver) {
		element = driver.findElement(By.xpath(premiumTotal));
		return element;
	}
	
	public static WebElement locationCodeField(WebDriver driver) {
		element = driver.findElement(By.xpath(locationCodeField));
		return element;
	}
