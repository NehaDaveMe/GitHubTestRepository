...
public class Report_LaborRateAnalysisOld 
{
	...
	static String takeAllEstimatedValue = "//input[@id='ctrlInsuranceEnrollment_txtPayrolls' or  @id='ctrlInsuranceEnrollment_txtManHours']";// AddContractor_WC_Premiums_Modifications_Page.premiumValues(driver);
