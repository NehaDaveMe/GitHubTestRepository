...
//			"//b[contains(text(),'Contractor Enrollment Summary')]";
	...
	//calculation xpath
	public static WebElement selectContractorPkg(WebDriver driver,String pkgNo) {
		element = driver.findElement(By.xpath("//span[contains(text(),'"+pkgNo+"')]"));
		return element;
	}
	
	public static List<WebElement> takeAllValues(WebDriver driver, String contractorPKGID) {
		listElement = driver.findElements(By.xpath("//span[contains(text(),'"+contractorPKGID+"')]/../../../../../../../../../../../tr[4]/td[2]/table/tbody/tr[1]//table//tr[position() >2 and position() <8]/td[2]"));
		return listElement;
	}
