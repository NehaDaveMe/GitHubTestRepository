...
public class AddProgram_Contractor_Portal_Options_Page {
	...
	static String ContractorPortalOption_GC_SubC_Sponsor_allswitches = "//div[@class='col-md-7 sm-bottom-10 clearfix']//div/table[@id='tblSubgenswitch']/tbody/tr[not(contains(@id,'divClaimsAccess'))]/td//div[@class='checker']/span/div[@class]";
	static String ActivateContractorPortalForThisProgram ="//div[@id='uniform-chkContractorPortalAccess']/span/div[@class]";
	
	public static List<WebElement> ActivateContractorPortalForThisProgram(WebDriver driver) {
		listElement = driver.findElements(By.xpath(ActivateContractorPortalForThisProgram));
		return listElement;
	}
	public static List<WebElement> ContractorPortalOption_GC_SubC_Sponsor_allswitches(WebDriver driver) {
		listElement = driver.findElements(By.xpath(ContractorPortalOption_GC_SubC_Sponsor_allswitches));
		return listElement;
	}
	//-----------------------Neha End---------------------------------------
}
