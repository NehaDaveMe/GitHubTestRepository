...
// GL class code drop down selection xpath with creating new cc	06/10/20
	...
	static String GLandUmbrellaCoverageTab="//div[@class='tabs_wrapper progrssTab']//ul[@class='le-tabs_tab_container popupTabs contractorMenu']/li[@id='ctrlInsuranceEnrollment_ctrlProgressBar_showGLUmbrellaCoverageinner']/a";
	public static WebElement GLandUmbrellaCoverageTab(WebDriver driver) {	
		element = driver.findElement(By.xpath(GLandUmbrellaCoverageTab));
		return element;
	}
	
	static String EstimatedInsuranceCostLink="//div[@class='tblrow overflowHide']/table/tbody/tr[@id='trDeductEntries']/td/a[contains(text(),'Click here to add an Estimated Insurance Cost Override')]";
	public static boolean EstimatedInsuranceCostLink(WebDriver driver) {	
		boolean b = driver.findElement(By.xpath(EstimatedInsuranceCostLink)).isDisplayed();
		return b;
	}
