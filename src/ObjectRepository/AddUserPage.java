...
public class AddUserPage {
	...
	static String selectSecurityProfile="//select[@id='ddlSecurity']";
	
	static String addUserContactTypeField = "//select[@id='ddlContactType']";// select
	static String requiredInfoAlertCloseBtn ="//a[text()='Close']";//ul[@id='divErrorMessage']/../div/a";
...
//		select.selectByVisibleText(status);
	...
	public static WebElement selectSecurityProfile(WebDriver driver) {
		element = driver.findElement(By.xpath(selectSecurityProfile));
		return element;
	}
	public static WebElement requiredInfoAlertCloseBtn(WebDriver driver) {
		element = driver.findElement(By.xpath(requiredInfoAlertCloseBtn));
		return element;
	}
