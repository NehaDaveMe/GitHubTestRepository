...
public class AddProgram_Program_Parameters_Page {
	...
	static String addSuspendedPayrollSaveAndCloseButton = "//a[@id='btnSavesuspendedInformation']";//input[@id='btnSavesuspendedInformation']";//id="btnSavesuspendedInformation"
