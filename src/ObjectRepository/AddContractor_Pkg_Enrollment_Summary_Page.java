...
public class AddContractor_Pkg_Enrollment_Summary_Page
{
	...
	static String WCPremiumsModificationGLandUmbrellaCoverageTabs = "//div[@class='col-md-12 clearfix']//div[@id='cssmenu']/ul[@id='myTab']/li/a";
	public static List<WebElement> WCPremiumsModificationGLandUmbrellaCoverageTabs(WebDriver driver) 
	{
		listElement = driver.findElements(By.xpath(WCPremiumsModificationGLandUmbrellaCoverageTabs));
		return listElement;
