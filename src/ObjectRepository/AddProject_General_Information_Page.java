...
//Add New Project Type Link	
	...
	static String minRequirementEnrollmentAllowedSwitch ="//div[@id='uniform-cntrWorkSiteAddUpdate_chkConditionalEnrollment']//div[@class]";
	...
	static String contractortoverifyinsurancecostcomparisonswitch ="//div[@id='uniform-cntrWorkSiteAddUpdate_chkVerifiedInsuranceCost']//div[@class]";
	
	public static WebElement contractortoverifyinsurancecostcomparisonswitch(WebDriver driver) {
		element = driver.findElement(By.xpath(contractortoverifyinsurancecostcomparisonswitch));
		return element;
	}
	
	static String TrackInsuranceCostSwitch ="//div[@id='uniform-cntrWorkSiteAddUpdate_chkIsTrackDeduct']//div[@class]";
	
	public static WebElement TrackInsuranceCostSwitch(WebDriver driver) {
		element = driver.findElement(By.xpath(TrackInsuranceCostSwitch));
		return element;
	}
