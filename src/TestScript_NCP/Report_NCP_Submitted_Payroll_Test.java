...
public class Report_NCP_Submitted_Payroll_Test extends BaseClass
{
	...
	public void testSubmittedPayrollReportNCP(String ProgramName, String Division, String Projects) throws InterruptedException 
	{
		...
		try {
			...
			wb.selectSingleValue(Report_NCP_Submitted_Payroll_Report.filterSelectContractorFormOption(driver), "All Contractors");
		...
		try {
			...
			test.log(LogStatus.PASS,"Program Name:- " + Report_NCP_Submitted_Payroll_Report.programName(driver).getText());
			test.log(LogStatus.PASS,"Sponsor Name:- " + Report_NCP_Submitted_Payroll_Report.sponsorName(driver).getText());
			test.log(LogStatus.PASS,"Project Name:- " + Report_NCP_Submitted_Payroll_Report.projectName(driver).getText());
			
			test.log(LogStatus.PASS,"Time Stamp:- " + Report_NCP_Submitted_Payroll_Report.timeStamp(driver).getText());
			test.log(LogStatus.PASS,"PDF Option is Present:- " + Report_NCP_Submitted_Payroll_Report.exportToPDF(driver).isDisplayed());
			test.log(LogStatus.PASS,"Excel Option is Present:- " + Report_NCP_Submitted_Payroll_Report.exportToExcel(driver).isDisplayed());
...
Object[][] data = new Object[row-1][col];//store all row and column in multidimensional array and print one by one
	...
	{
		List<WebElement> countOfContractorPkg = Report_NCP_Submitted_Payroll_Report.countProjectWiseContractorPkg(driver);
